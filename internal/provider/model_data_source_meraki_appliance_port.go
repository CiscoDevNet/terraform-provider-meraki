...
// It emits a separate model - DataSourceAppliancePort - used only by the data source, always including every
...
type DataSourceAppliancePort struct {
...
func (data DataSourceAppliancePort) getPath() string {
...
func (data *DataSourceAppliancePort) fromBody(ctx context.Context, res meraki.Res) {
