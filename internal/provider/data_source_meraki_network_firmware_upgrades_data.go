...
var (
	_ datasource.DataSource              = &NetworkFirmwareUpgradesDataDataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkFirmwareUpgradesDataDataSource{}
)

func NewNetworkFirmwareUpgradesDataDataSource() datasource.DataSource {
	return &NetworkFirmwareUpgradesDataDataSource{}
}

type NetworkFirmwareUpgradesDataDataSource struct {
	client *meraki.Client
}

func (d *NetworkFirmwareUpgradesDataDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_network_firmware_upgrades_data"
}

func (d *NetworkFirmwareUpgradesDataDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Network Firmware Upgrades Data` configuration.").String,
...
func (d *NetworkFirmwareUpgradesDataDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *NetworkFirmwareUpgradesDataDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config NetworkFirmwareUpgradesData
