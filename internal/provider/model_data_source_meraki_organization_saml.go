...
// It emits a separate model - DataSourceOrganizationSAML - used only by the data source, always including every
...
type DataSourceOrganizationSAML struct {
...
func (data DataSourceOrganizationSAML) getPath() string {
...
func (data *DataSourceOrganizationSAML) fromBody(ctx context.Context, res meraki.Res) {
