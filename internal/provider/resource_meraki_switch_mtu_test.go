...
func TestAccMerakiSwitchMTU(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		ResourceName:            "meraki_switch_mtu.test",
		ImportState:             true,
		ImportStateVerify:       true,
		ImportStateIdFunc:       merakiSwitchMTUImportStateIdFunc("meraki_switch_mtu.test"),
...
func merakiSwitchMTUImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
