...
// It emits a separate model - DataSourceSwitchDSCPToCoSMappings - used only by the data source, always including every
...
type DataSourceSwitchDSCPToCoSMappings struct {
	Id        types.String                                `tfsdk:"id"`
	NetworkId types.String                                `tfsdk:"network_id"`
	Mappings  []DataSourceSwitchDSCPToCoSMappingsMappings `tfsdk:"mappings"`
}

type DataSourceSwitchDSCPToCoSMappingsMappings struct {
...
func (data DataSourceSwitchDSCPToCoSMappings) getPath() string {
...
func (data *DataSourceSwitchDSCPToCoSMappings) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("mappings"); value.Exists() && value.Value() != nil {
		data.Mappings = make([]DataSourceSwitchDSCPToCoSMappingsMappings, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchDSCPToCoSMappingsMappings{}
