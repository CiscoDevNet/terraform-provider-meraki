...
// It emits a separate model - DataSourceApplianceDNSLocalProfile - used only by the data source, always including every
...
type DataSourceApplianceDNSLocalProfile struct {
...
func (data DataSourceApplianceDNSLocalProfile) getPath() string {
...
func (data *DataSourceApplianceDNSLocalProfile) fromBody(ctx context.Context, res meraki.Res) {
