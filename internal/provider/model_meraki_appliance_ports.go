...
type AppliancePorts struct {
	...
	Items     []AppliancePortsItems `tfsdk:"items"`
}
...
func (data AppliancePorts) getPath() string {
...
func (data *AppliancePorts) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]AppliancePortsItems, 0)
