...
// It emits a separate model - DataSourceCellularGatewaySubnetPool - used only by the data source, always including every
...
type DataSourceCellularGatewaySubnetPool struct {
...
func (data DataSourceCellularGatewaySubnetPool) getPath() string {
...
func (data *DataSourceCellularGatewaySubnetPool) fromBody(ctx context.Context, res meraki.Res) {
