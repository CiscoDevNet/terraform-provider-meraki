...
type DataSourceSwitchPorts struct {
	Serial types.String                 `tfsdk:"serial"`
	Items  []DataSourceSwitchPortsItems `tfsdk:"items"`
}
...
func (data DataSourceSwitchPorts) getPath() string {
...
func (data *DataSourceSwitchPorts) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceSwitchPortsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceSwitchPortsItems{}
