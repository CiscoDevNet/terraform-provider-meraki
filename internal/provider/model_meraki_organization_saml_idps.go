...
type OrganizationSAMLIdPs struct {
	OrganizationId types.String                `tfsdk:"organization_id"`
	Items          []OrganizationSAMLIdPsItems `tfsdk:"items"`
}

type OrganizationSAMLIdPsItems struct {
...
func (data OrganizationSAMLIdPs) getPath() string {
...
func (data *OrganizationSAMLIdPs) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]OrganizationSAMLIdPsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := OrganizationSAMLIdPsItems{}
