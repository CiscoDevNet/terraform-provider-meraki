...
func (data *WirelessBilling) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *WirelessBilling) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data WirelessBilling) addDeleteValues(ctx context.Context, body string) string {
	return body
}
