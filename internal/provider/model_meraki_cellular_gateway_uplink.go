...
func (data CellularGatewayUplink) getPath() string {
...
func (data CellularGatewayUplink) toBody(ctx context.Context, state CellularGatewayUplink) string {
	body := ""
...
func (data CellularGatewayUplink) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data *CellularGatewayUplink) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *CellularGatewayUplink) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *CellularGatewayUplink) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data CellularGatewayUplink) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
