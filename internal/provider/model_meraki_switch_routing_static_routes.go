...
type SwitchRoutingStaticRoutes struct {
	...
	Items  []SwitchRoutingStaticRoutesItems `tfsdk:"items"`
}

type SwitchRoutingStaticRoutesItems struct {
...
func (data SwitchRoutingStaticRoutes) getPath() string {
...
func (data *SwitchRoutingStaticRoutes) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]SwitchRoutingStaticRoutesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := SwitchRoutingStaticRoutesItems{}
