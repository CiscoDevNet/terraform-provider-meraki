...
// It emits a separate model - DataSourceSwitchStack - used only by the data source, always including every
...
type DataSourceSwitchStack struct {
...
func (data DataSourceSwitchStack) getPath() string {
...
func (data *DataSourceSwitchStack) fromBody(ctx context.Context, res meraki.Res) {
