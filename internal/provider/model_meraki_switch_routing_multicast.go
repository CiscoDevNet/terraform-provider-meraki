...
func (data *SwitchRoutingMulticast) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data SwitchRoutingMulticast) addDeleteValues(ctx context.Context, body string) string {
	return body
}
