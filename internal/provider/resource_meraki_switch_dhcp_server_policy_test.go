...
func TestAccMerakiSwitchDHCPServerPolicy(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		ResourceName:            "meraki_switch_dhcp_server_policy.test",
		ImportState:             true,
		ImportStateVerify:       true,
		ImportStateIdFunc:       merakiSwitchDHCPServerPolicyImportStateIdFunc("meraki_switch_dhcp_server_policy.test"),
...
func merakiSwitchDHCPServerPolicyImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
