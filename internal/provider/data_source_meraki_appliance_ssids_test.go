...
func TestAccDataSourceMerakiApplianceSSIDs(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceMerakiApplianceSSIDsPrerequisitesConfig + testAccDataSourceMerakiApplianceSSIDsConfig(),
			},
		},
	})
}
...
const testAccDataSourceMerakiApplianceSSIDsPrerequisitesConfig = `
variable "test_org" {}
...
func testAccDataSourceMerakiApplianceSSIDsConfig() string {
	config := `data "meraki_appliance_ssids" "test" {
