...
func (data *ApplianceConnectivityMonitoringDestinations) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *ApplianceConnectivityMonitoringDestinations) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
