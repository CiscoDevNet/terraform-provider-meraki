...
var (
	_ datasource.DataSource              = &OrganizationPolicyObjectsDataSource{}
	_ datasource.DataSourceWithConfigure = &OrganizationPolicyObjectsDataSource{}
)

func NewOrganizationPolicyObjectsDataSource() datasource.DataSource {
	return &OrganizationPolicyObjectsDataSource{}
}

type OrganizationPolicyObjectsDataSource struct {
	client *meraki.Client
}

func (d *OrganizationPolicyObjectsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *OrganizationPolicyObjectsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *OrganizationPolicyObjectsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Beginning Read", "OrganizationPolicyObjectsDataSource"))
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Read finished successfully", "OrganizationPolicyObjectsDataSource"))
