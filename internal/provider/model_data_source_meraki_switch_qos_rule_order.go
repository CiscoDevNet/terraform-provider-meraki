...
// It emits a separate model - DataSourceSwitchQoSRuleOrder - used only by the data source, always including every
...
type DataSourceSwitchQoSRuleOrder struct {
...
func (data DataSourceSwitchQoSRuleOrder) getPath() string {
...
func (data *DataSourceSwitchQoSRuleOrder) fromBody(ctx context.Context, res meraki.Res) {
