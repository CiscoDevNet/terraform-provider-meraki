...
type ResourceWirelessSSIDIdentityPSKs struct {
	Id             types.String                            `tfsdk:"id"`
	OrganizationId types.String                            `tfsdk:"organization_id"`
	NetworkId      types.String                            `tfsdk:"network_id"`
	Number         types.String                            `tfsdk:"number"`
	Items          []ResourceWirelessSSIDIdentityPSKsItems `tfsdk:"items"`
}

type ResourceWirelessSSIDIdentityPSKsItems struct {
	Id            types.String `tfsdk:"id"`
...
func (data ResourceWirelessSSIDIdentityPSKs) getPath() string {
...
func (data ResourceWirelessSSIDIdentityPSKsItems) toBody(ctx context.Context, state ResourceWirelessSSIDIdentityPSKsItems) string {
	body := ""
...
func (data *ResourceWirelessSSIDIdentityPSKs) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data ResourceWirelessSSIDIdentityPSKs) addDeleteValues(ctx context.Context) string {
	body := ""
	return body
}
...
func (data *ResourceWirelessSSIDIdentityPSKs) hasChanges(ctx context.Context, state *ResourceWirelessSSIDIdentityPSKs, id string) bool {
	...
	stateItem := ResourceWirelessSSIDIdentityPSKsItems{}
	...
	if !item.ExpiresAt.Equal(stateItem.ExpiresAt) {
		hasChanges = true
	}
	...
	if !item.Passphrase.Equal(stateItem.Passphrase) {
		hasChanges = true
	}
	return hasChanges
}
