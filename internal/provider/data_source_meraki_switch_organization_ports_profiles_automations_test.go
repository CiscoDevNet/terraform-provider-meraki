...
func TestAccDataSourceMerakiSwitchOrganizationPortsProfilesAutomations(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceMerakiSwitchOrganizationPortsProfilesAutomationsPrerequisitesConfig + testAccDataSourceMerakiSwitchOrganizationPortsProfilesAutomationsConfig(),
			},
		},
	})
}
...
const testAccDataSourceMerakiSwitchOrganizationPortsProfilesAutomationsPrerequisitesConfig = `
variable "test_org" {}
...
func testAccDataSourceMerakiSwitchOrganizationPortsProfilesAutomationsConfig() string {
	config := `data "meraki_switch_organization_ports_profiles_automations" "test" {
			organization_id = data.meraki_organization.test.id
		}
	`
	return config
