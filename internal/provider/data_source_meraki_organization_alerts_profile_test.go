...
func TestAccDataSourceMerakiOrganizationAlertsProfile(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_organization_alerts_profile.test", "recipients_emails.0", "admin@example.org"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_organization_alerts_profile.test", "network_tags.0", "tag1"))
