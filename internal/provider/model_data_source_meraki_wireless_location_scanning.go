...
// It emits a separate model - DataSourceWirelessLocationScanning - used only by the data source, always including every
...
type DataSourceWirelessLocationScanning struct {
...
func (data DataSourceWirelessLocationScanning) getPath() string {
...
func (data *DataSourceWirelessLocationScanning) fromBody(ctx context.Context, res meraki.Res) {
