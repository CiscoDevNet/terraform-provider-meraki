...
func TestAccMerakiWirelessSSIDDeviceTypeGroupPolicies(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_wireless_ssid_device_type_group_policies.test", "device_type_policies.0.device_policy", "Allowed"))
	checks = append(checks, resource.TestCheckResourceAttr("meraki_wireless_ssid_device_type_group_policies.test", "device_type_policies.0.device_type", "Android"))
...
func merakiWirelessSSIDDeviceTypeGroupPoliciesImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
const testAccMerakiWirelessSSIDDeviceTypeGroupPoliciesPrerequisitesConfig = `
variable "test_org" {}
