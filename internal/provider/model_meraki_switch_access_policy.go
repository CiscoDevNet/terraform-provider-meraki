...
func (data *SwitchAccessPolicy) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *SwitchAccessPolicy) fromBodyPartial(ctx context.Context, res gjson.Result) {
