...
func TestAccMerakiOrganizationAdaptivePolicies(t *testing.T) {
	...
	if os.Getenv("SKIP_MINIMUM_TEST") == "" {
		steps = append(steps, resource.TestStep{
			Config: testAccMerakiOrganizationAdaptivePoliciesPrerequisitesConfig + testAccMerakiOrganizationAdaptivePoliciesConfig_minimum(),
		})
	}
	steps = append(steps, resource.TestStep{
		Config: testAccMerakiOrganizationAdaptivePoliciesPrerequisitesConfig + testAccMerakiOrganizationAdaptivePoliciesConfig_all(),
	})
	steps = append(steps, resource.TestStep{
		ResourceName:      "meraki_organization_adaptive_policies.test",
		ImportState:       true,
		ImportStateIdFunc: merakiOrganizationAdaptivePoliciesImportStateIdFunc("meraki_organization_adaptive_policies.test"),
	})
...
func merakiOrganizationAdaptivePoliciesImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
const testAccMerakiOrganizationAdaptivePoliciesPrerequisitesConfig = `
variable "test_org" {}
...
func testAccMerakiOrganizationAdaptivePoliciesConfig_minimum() string {
	config := `resource "meraki_organization_adaptive_policies" "test" {` + "\n"
...
func testAccMerakiOrganizationAdaptivePoliciesConfig_all() string {
	config := `resource "meraki_organization_adaptive_policies" "test" {` + "\n"
	config += ` organization_id = data.meraki_organization.test.id` + "\n"
	config += ` items = [{` + "\n"
