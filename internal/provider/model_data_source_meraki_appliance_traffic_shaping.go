...
// It emits a separate model - DataSourceApplianceTrafficShaping - used only by the data source, always including every
...
type DataSourceApplianceTrafficShaping struct {
...
func (data DataSourceApplianceTrafficShaping) getPath() string {
...
func (data *DataSourceApplianceTrafficShaping) fromBody(ctx context.Context, res meraki.Res) {
