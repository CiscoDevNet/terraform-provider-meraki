...
type ApplianceCellularInboundFirewallRules struct {
	Id        types.String                                 `tfsdk:"id"`
	NetworkId types.String                                 `tfsdk:"network_id"`
	Rules     []ApplianceCellularInboundFirewallRulesRules `tfsdk:"rules"`
}

type ApplianceCellularInboundFirewallRulesRules struct {
...
func (data ApplianceCellularInboundFirewallRules) getPath() string {
...
func (data ApplianceCellularInboundFirewallRules) toBody(ctx context.Context, state ApplianceCellularInboundFirewallRules) string {
	body := ""
	{
...
func (data *ApplianceCellularInboundFirewallRules) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("rules"); value.Exists() && value.Value() != nil {
		data.Rules = make([]ApplianceCellularInboundFirewallRulesRules, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := ApplianceCellularInboundFirewallRulesRules{}
...
func (data *ApplianceCellularInboundFirewallRules) fromBodyPartial(ctx context.Context, res meraki.Res) {
	{
...
func (data *ApplianceCellularInboundFirewallRules) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
