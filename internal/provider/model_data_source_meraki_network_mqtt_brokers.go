...
type DataSourceNetworkMQTTBrokers struct {
	NetworkId types.String                        `tfsdk:"network_id"`
	Items     []DataSourceNetworkMQTTBrokersItems `tfsdk:"items"`
}

type DataSourceNetworkMQTTBrokersItems struct {
...
func (data DataSourceNetworkMQTTBrokers) getPath() string {
...
func (data *DataSourceNetworkMQTTBrokers) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceNetworkMQTTBrokersItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceNetworkMQTTBrokersItems{}
