...
// It emits a separate model - DataSourceApplianceContentFiltering - used only by the data source, always including every
...
type DataSourceApplianceContentFiltering struct {
...
func (data DataSourceApplianceContentFiltering) getPath() string {
...
func (data *DataSourceApplianceContentFiltering) fromBody(ctx context.Context, res meraki.Res) {
