...
type DataSourceApplianceTrafficShapingCustomPerformanceClasses struct {
	NetworkId types.String                                                     `tfsdk:"network_id"`
	Items     []DataSourceApplianceTrafficShapingCustomPerformanceClassesItems `tfsdk:"items"`
}

type DataSourceApplianceTrafficShapingCustomPerformanceClassesItems struct {
...
func (data DataSourceApplianceTrafficShapingCustomPerformanceClasses) getPath() string {
...
func (data *DataSourceApplianceTrafficShapingCustomPerformanceClasses) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceApplianceTrafficShapingCustomPerformanceClassesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceApplianceTrafficShapingCustomPerformanceClassesItems{}
