...
var (
	_ datasource.DataSource              = &SwitchStackRoutingInterfacesDataSource{}
	_ datasource.DataSourceWithConfigure = &SwitchStackRoutingInterfacesDataSource{}
)

func NewSwitchStackRoutingInterfacesDataSource() datasource.DataSource {
	return &SwitchStackRoutingInterfacesDataSource{}
}

type SwitchStackRoutingInterfacesDataSource struct {
	client *meraki.Client
}

func (d *SwitchStackRoutingInterfacesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *SwitchStackRoutingInterfacesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the `Switch Stack Routing Interface` configuration.",
...
func (d *SwitchStackRoutingInterfacesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *SwitchStackRoutingInterfacesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config SwitchStackRoutingInterfaces
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Beginning Read", "SwitchStackRoutingInterfacesDataSource"))
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Read finished successfully", "SwitchStackRoutingInterfacesDataSource"))
