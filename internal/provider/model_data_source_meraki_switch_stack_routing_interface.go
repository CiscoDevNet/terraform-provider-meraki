...
// It emits a separate model - DataSourceSwitchStackRoutingInterface - used only by the data source, always including every
...
type DataSourceSwitchStackRoutingInterface struct {
...
func (data DataSourceSwitchStackRoutingInterface) getPath() string {
...
func (data *DataSourceSwitchStackRoutingInterface) fromBody(ctx context.Context, res meraki.Res) {
