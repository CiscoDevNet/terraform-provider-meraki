...
type WirelessSSIDFirewallIsolationAllowlistEntries struct {
	OrganizationId types.String                                         `tfsdk:"organization_id"`
	Items          []WirelessSSIDFirewallIsolationAllowlistEntriesItems `tfsdk:"items"`
}

type WirelessSSIDFirewallIsolationAllowlistEntriesItems struct {
...
func (data WirelessSSIDFirewallIsolationAllowlistEntries) getPath() string {
...
func (data *WirelessSSIDFirewallIsolationAllowlistEntries) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]WirelessSSIDFirewallIsolationAllowlistEntriesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := WirelessSSIDFirewallIsolationAllowlistEntriesItems{}
