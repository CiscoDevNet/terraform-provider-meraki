...
// It emits a separate model - DataSourceOrganizationAdaptivePolicySettings - used only by the data source, always including every
...
type DataSourceOrganizationAdaptivePolicySettings struct {
...
func (data DataSourceOrganizationAdaptivePolicySettings) getPath() string {
...
func (data *DataSourceOrganizationAdaptivePolicySettings) fromBody(ctx context.Context, res meraki.Res) {
