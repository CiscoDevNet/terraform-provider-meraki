...
func TestAccMerakiNetworkClientPolicy(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		ResourceName:            "meraki_network_client_policy.test",
		ImportState:             true,
		ImportStateVerify:       true,
		ImportStateIdFunc:       merakiNetworkClientPolicyImportStateIdFunc("meraki_network_client_policy.test"),
...
func merakiNetworkClientPolicyImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
