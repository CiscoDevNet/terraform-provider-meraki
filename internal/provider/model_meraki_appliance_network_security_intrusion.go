...
func (data *ApplianceNetworkSecurityIntrusion) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data ApplianceNetworkSecurityIntrusion) addDeleteValues(ctx context.Context, body string) string {
	return body
}
