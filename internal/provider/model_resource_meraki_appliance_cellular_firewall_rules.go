...
type ApplianceCellularFirewallRules struct {
	Id        types.String                          `tfsdk:"id"`
	NetworkId types.String                          `tfsdk:"network_id"`
	Rules     []ApplianceCellularFirewallRulesRules `tfsdk:"rules"`
}

type ApplianceCellularFirewallRulesRules struct {
...
type ApplianceCellularFirewallRulesIdentity struct {
	NetworkId types.String `tfsdk:"network_id"`
}
...
func (data ApplianceCellularFirewallRules) getPath() string {
	return fmt.Sprintf("/networks/%v/appliance/firewall/cellularFirewallRules", url.QueryEscape(data.NetworkId.ValueString()))
}
...
func (data ApplianceCellularFirewallRules) toBody(ctx context.Context, state ApplianceCellularFirewallRules) string {
	body := ""
	{
...
func (data ApplianceCellularFirewallRules) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data *ApplianceCellularFirewallRules) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("rules"); value.Exists() && value.Value() != nil {
		data.Rules = make([]ApplianceCellularFirewallRulesRules, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			if value := res.Get("comment"); value.String() == "Default rule" {
				return true
			}
			parent := &data
			data := ApplianceCellularFirewallRulesRules{}
...
func (data *ApplianceCellularFirewallRules) fromBodyPartial(ctx context.Context, res meraki.Res) {
	{
...
func (data *ApplianceCellularFirewallRules) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data *ApplianceCellularFirewallRulesIdentity) toIdentity(ctx context.Context, plan *ApplianceCellularFirewallRules) {
...
func (data *ApplianceCellularFirewallRules) fromIdentity(ctx context.Context, identity *ApplianceCellularFirewallRulesIdentity) {
