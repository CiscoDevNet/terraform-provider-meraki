...
type NetworkCellularGatewaySubnetPool struct {
...
func (data NetworkCellularGatewaySubnetPool) getPath() string {
...
func (data NetworkCellularGatewaySubnetPool) toBody(ctx context.Context, state NetworkCellularGatewaySubnetPool) string {
	body := ""
	if !data.Cidr.IsNull() {
...
func (data *NetworkCellularGatewaySubnetPool) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *NetworkCellularGatewaySubnetPool) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *NetworkCellularGatewaySubnetPool) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
