...
// It emits a separate model - DataSourceSwitchRoutingInterface - used only by the data source, always including every
...
type DataSourceSwitchRoutingInterface struct {
...
func (data DataSourceSwitchRoutingInterface) getPath() string {
...
func (data *DataSourceSwitchRoutingInterface) fromBody(ctx context.Context, res meraki.Res) {
