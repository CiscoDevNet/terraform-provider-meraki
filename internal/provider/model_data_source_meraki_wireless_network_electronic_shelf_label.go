...
// It emits a separate model - DataSourceWirelessNetworkElectronicShelfLabel - used only by the data source, always including every
...
type DataSourceWirelessNetworkElectronicShelfLabel struct {
...
func (data DataSourceWirelessNetworkElectronicShelfLabel) getPath() string {
...
func (data *DataSourceWirelessNetworkElectronicShelfLabel) fromBody(ctx context.Context, res meraki.Res) {
