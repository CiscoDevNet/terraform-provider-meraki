...
// It emits a separate model - DataSourceSMTargetGroup - used only by the data source, always including every
...
type DataSourceSMTargetGroup struct {
...
func (data DataSourceSMTargetGroup) getPath() string {
...
func (data *DataSourceSMTargetGroup) fromBody(ctx context.Context, res meraki.Res) {
