...
type OrganizationAlertsProfiles struct {
	OrganizationId types.String                      `tfsdk:"organization_id"`
	Items          []OrganizationAlertsProfilesItems `tfsdk:"items"`
}

type OrganizationAlertsProfilesItems struct {
...
func (data OrganizationAlertsProfiles) getPath() string {
...
func (data *OrganizationAlertsProfiles) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]OrganizationAlertsProfilesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := OrganizationAlertsProfilesItems{}
