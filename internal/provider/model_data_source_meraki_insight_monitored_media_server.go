...
// It emits a separate model - DataSourceInsightMonitoredMediaServer - used only by the data source, always including every
...
type DataSourceInsightMonitoredMediaServer struct {
...
func (data DataSourceInsightMonitoredMediaServer) getPath() string {
...
func (data *DataSourceInsightMonitoredMediaServer) fromBody(ctx context.Context, res meraki.Res) {
