...
func merakiSwitchRoutingStaticRoutesImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
const testAccMerakiSwitchRoutingStaticRoutesPrerequisitesConfig = `
variable "test_org" {}
...
func testAccMerakiSwitchRoutingStaticRoutesConfig_minimum() string {
	config := `resource "meraki_switch_routing_static_routes" "test" {` + "\n"
...
func testAccMerakiSwitchRoutingStaticRoutesConfig_all() string {
	config := `resource "meraki_switch_routing_static_routes" "test" {` + "\n"
	config += ` serial = meraki_switch_routing_interface.test.serial` + "\n"
	config += ` organization_id = data.meraki_organization.test.id` + "\n"
	config += ` items = [{` + "\n"
