...
// It emits a separate model - DataSourceCameraQualityRetentionProfile - used only by the data source, always including every
...
type DataSourceCameraQualityRetentionProfile struct {
...
func (data DataSourceCameraQualityRetentionProfile) getPath() string {
...
func (data *DataSourceCameraQualityRetentionProfile) fromBody(ctx context.Context, res meraki.Res) {
