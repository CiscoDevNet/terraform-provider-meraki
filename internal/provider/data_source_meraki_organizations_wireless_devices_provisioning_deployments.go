...
var (
	_ datasource.DataSource              = &OrganizationsWirelessDevicesProvisioningDeploymentsDataSource{}
	_ datasource.DataSourceWithConfigure = &OrganizationsWirelessDevicesProvisioningDeploymentsDataSource{}
)

func NewOrganizationsWirelessDevicesProvisioningDeploymentsDataSource() datasource.DataSource {
	return &OrganizationsWirelessDevicesProvisioningDeploymentsDataSource{}
}

type OrganizationsWirelessDevicesProvisioningDeploymentsDataSource struct {
	client *meraki.Client
}

func (d *OrganizationsWirelessDevicesProvisioningDeploymentsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_organizations_wireless_devices_provisioning_deployments"
}

func (d *OrganizationsWirelessDevicesProvisioningDeploymentsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Organizations Wireless Devices Provisioning Deployments` configuration.").String,
...
func (d *OrganizationsWirelessDevicesProvisioningDeploymentsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *OrganizationsWirelessDevicesProvisioningDeploymentsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config OrganizationsWirelessDevicesProvisioningDeployments
