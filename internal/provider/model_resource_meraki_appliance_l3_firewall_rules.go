...
type ApplianceL3FirewallRules struct {
	Id                types.String                    `tfsdk:"id"`
	NetworkId         types.String                    `tfsdk:"network_id"`
	SyslogDefaultRule types.Bool                      `tfsdk:"syslog_default_rule"`
	Rules             []ApplianceL3FirewallRulesRules `tfsdk:"rules"`
}

type ApplianceL3FirewallRulesRules struct {
...
type ApplianceL3FirewallRulesIdentity struct {
	NetworkId types.String `tfsdk:"network_id"`
}
...
func (data ApplianceL3FirewallRules) getPath() string {
	return fmt.Sprintf("/networks/%v/appliance/firewall/l3FirewallRules", url.QueryEscape(data.NetworkId.ValueString()))
}
...
func (data ApplianceL3FirewallRules) toBody(ctx context.Context, state ApplianceL3FirewallRules) string {
	body := ""
...
func (data ApplianceL3FirewallRules) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data *ApplianceL3FirewallRules) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("rules"); value.Exists() && value.Value() != nil {
		...
		value.ForEach(func(k, res gjson.Result) bool {
			...
			parent := &data
			data := ApplianceL3FirewallRulesRules{}
...
func (data *ApplianceL3FirewallRules) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data *ApplianceL3FirewallRulesIdentity) toIdentity(ctx context.Context, plan *ApplianceL3FirewallRules) {
...
func (data *ApplianceL3FirewallRules) fromIdentity(ctx context.Context, identity *ApplianceL3FirewallRulesIdentity) {
