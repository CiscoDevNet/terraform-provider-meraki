...
type DataSourceOrganizationWirelessDevicesProvisioningDeploymentss struct {
	OrganizationId types.String                                                         `tfsdk:"organization_id"`
	Items          []DataSourceOrganizationWirelessDevicesProvisioningDeploymentssItems `tfsdk:"items"`
}

type DataSourceOrganizationWirelessDevicesProvisioningDeploymentssItems struct {
	...
	Items                    []DataSourceOrganizationWirelessDevicesProvisioningDeploymentssItemsItems `tfsdk:"items"`
}

type DataSourceOrganizationWirelessDevicesProvisioningDeploymentssItemsItems struct {
...
func (data DataSourceOrganizationWirelessDevicesProvisioningDeploymentss) getPath() string {
...
func (data *DataSourceOrganizationWirelessDevicesProvisioningDeploymentss) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceOrganizationWirelessDevicesProvisioningDeploymentssItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceOrganizationWirelessDevicesProvisioningDeploymentssItems{}
		...
		if value := res.Get("items"); value.Exists() && value.Value() != nil {
			data.Items = make([]DataSourceOrganizationWirelessDevicesProvisioningDeploymentssItemsItems, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := DataSourceOrganizationWirelessDevicesProvisioningDeploymentssItemsItems{}
