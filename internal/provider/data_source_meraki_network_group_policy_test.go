...
func TestAccDataSourceMerakiNetworkGroupPolicy(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "bandwidth_bandwidth_limits_limit_up", "1000000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "bandwidth_bandwidth_limits_limit_down", "1000000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "firewall_and_traffic_shaping_l7_firewall_rules.0.policy", "deny"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "firewall_and_traffic_shaping_l7_firewall_rules.0.type", "host"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "firewall_and_traffic_shaping_l7_firewall_rules.0.value", "google.com"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "firewall_and_traffic_shaping_traffic_shaping_rules.0.definitions.0.type", "host"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "firewall_and_traffic_shaping_traffic_shaping_rules.0.definitions.0.value", "google.com"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "firewall_and_traffic_shaping_traffic_shaping_rules.0.per_client_bandwidth_limits_settings", "custom"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "firewall_and_traffic_shaping_traffic_shaping_rules.0.per_client_bandwidth_limits_bandwidth_limits_limit_up", "1000000"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "firewall_and_traffic_shaping_l3_firewall_rules.0.comment", "Allow TCP traffic to subnet with HTTP servers."))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_group_policy.test", "firewall_and_traffic_shaping_l3_firewall_rules.0.policy", "allow"))
...
func testAccDataSourceMerakiNetworkGroupPolicyConfig() string {
	...
	config += `	firewall_and_traffic_shaping_l7_firewall_rules = [{` + "\n"
	config += `		policy = "deny"` + "\n"
	config += `		type = "host"` + "\n"
	config += `		value = "google.com"` + "\n"
	config += `	}]` + "\n"
	config += `	firewall_and_traffic_shaping_settings = "custom"` + "\n"
	config += `	firewall_and_traffic_shaping_traffic_shaping_rules = [{` + "\n"
	config += `		definitions = [{` + "\n"
	config += `			type = "host"` + "\n"
	config += `			value = "google.com"` + "\n"
	config += `		}]` + "\n"
	...
	config += `	}]` + "\n"
	config += `	firewall_and_traffic_shaping_l3_firewall_rules = [{` + "\n"
	config += `		protocol = "tcp"` + "\n"
