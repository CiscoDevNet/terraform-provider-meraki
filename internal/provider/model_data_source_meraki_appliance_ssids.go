...
type DataSourceApplianceSSIDs struct {
	NetworkId types.String                    `tfsdk:"network_id"`
	Items     []DataSourceApplianceSSIDsItems `tfsdk:"items"`
}

type DataSourceApplianceSSIDsItems struct {
	...
	RadiusServers     []DataSourceApplianceSSIDsRadiusServers `tfsdk:"radius_servers"`
}

type DataSourceApplianceSSIDsRadiusServers struct {
...
func (data DataSourceApplianceSSIDs) getPath() string {
...
func (data *DataSourceApplianceSSIDs) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceApplianceSSIDsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceApplianceSSIDsItems{}
		...
		if value := res.Get("radiusServers"); value.Exists() && value.Value() != nil {
			data.RadiusServers = make([]DataSourceApplianceSSIDsRadiusServers, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := DataSourceApplianceSSIDsRadiusServers{}
