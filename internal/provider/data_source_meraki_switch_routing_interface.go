...
var (
	_ datasource.DataSource              = &SwitchRoutingInterfaceDataSource{}
	_ datasource.DataSourceWithConfigure = &SwitchRoutingInterfaceDataSource{}
)

func NewSwitchRoutingInterfaceDataSource() datasource.DataSource {
	return &SwitchRoutingInterfaceDataSource{}
}

type SwitchRoutingInterfaceDataSource struct {
	client *meraki.Client
}

func (d *SwitchRoutingInterfaceDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_switch_routing_interface"
}

func (d *SwitchRoutingInterfaceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Switch Routing Interface` configuration.").AddEarlyAccessDescription().String,
...
func (d *SwitchRoutingInterfaceDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *SwitchRoutingInterfaceDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
