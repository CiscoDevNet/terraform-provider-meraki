...
// It emits a separate model - DataSourceOrganizationExtensionsThousandEyesNetwork - used only by the data source, always including every
...
type DataSourceOrganizationExtensionsThousandEyesNetwork struct {
	Id             types.String                                               `tfsdk:"id"`
	OrganizationId types.String                                               `tfsdk:"organization_id"`
	Enabled        types.Bool                                                 `tfsdk:"enabled"`
	NetworkId      types.String                                               `tfsdk:"network_id"`
	Tests          []DataSourceOrganizationExtensionsThousandEyesNetworkTests `tfsdk:"tests"`
}

type DataSourceOrganizationExtensionsThousandEyesNetworkTests struct {
	NetworkId                types.String `tfsdk:"network_id"`
...
func (data DataSourceOrganizationExtensionsThousandEyesNetwork) getPath() string {
...
func (data *DataSourceOrganizationExtensionsThousandEyesNetwork) fromBody(ctx context.Context, res meraki.Res) {
