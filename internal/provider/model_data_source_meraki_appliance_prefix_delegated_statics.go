...
type DataSourceAppliancePrefixDelegatedStatics struct {
	NetworkId types.String                                     `tfsdk:"network_id"`
	Items     []DataSourceAppliancePrefixDelegatedStaticsItems `tfsdk:"items"`
}

type DataSourceAppliancePrefixDelegatedStaticsItems struct {
...
func (data DataSourceAppliancePrefixDelegatedStatics) getPath() string {
...
func (data *DataSourceAppliancePrefixDelegatedStatics) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceAppliancePrefixDelegatedStaticsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceAppliancePrefixDelegatedStaticsItems{}
