...
var (
	_ datasource.DataSource              = &SwitchRoutingStaticRouteDataSource{}
	_ datasource.DataSourceWithConfigure = &SwitchRoutingStaticRouteDataSource{}
)

func NewSwitchRoutingStaticRouteDataSource() datasource.DataSource {
	return &SwitchRoutingStaticRouteDataSource{}
}

type SwitchRoutingStaticRouteDataSource struct {
	client *meraki.Client
}

func (d *SwitchRoutingStaticRouteDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_switch_routing_static_route"
}

func (d *SwitchRoutingStaticRouteDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *SwitchRoutingStaticRouteDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *SwitchRoutingStaticRouteDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
