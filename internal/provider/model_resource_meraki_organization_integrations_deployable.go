...
type OrganizationIntegrationsDeployableIdentity struct {
	OrganizationId types.String `tfsdk:"organization_id"`
}
...
func (data *OrganizationIntegrationsDeployableIdentity) toIdentity(ctx context.Context, plan *OrganizationIntegrationsDeployable) {
...
func (data *OrganizationIntegrationsDeployable) fromIdentity(ctx context.Context, identity *OrganizationIntegrationsDeployableIdentity) {
