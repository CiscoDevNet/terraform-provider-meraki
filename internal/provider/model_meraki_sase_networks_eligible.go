...
type SaseNetworksEligible struct {
	...
	Items                    []SaseNetworksEligibleItems `tfsdk:"items"`
}

type SaseNetworksEligibleItems struct {
...
func (data SaseNetworksEligible) getPath() string {
...
func (data SaseNetworksEligible) toBody(ctx context.Context, state SaseNetworksEligible) string {
	body := ""
...
func (data *SaseNetworksEligible) fromBody(ctx context.Context, res meraki.Res) {
	...
	if value := res.Get("items"); value.Exists() && value.Value() != nil {
		data.Items = make([]SaseNetworksEligibleItems, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := SaseNetworksEligibleItems{}
...
func (data *SaseNetworksEligible) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *SaseNetworksEligible) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data SaseNetworksEligible) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
