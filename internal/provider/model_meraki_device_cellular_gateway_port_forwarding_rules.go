...
type DeviceCellularGatewayPortForwardingRules struct {
	Id     types.String                                    `tfsdk:"id"`
	Serial types.String                                    `tfsdk:"serial"`
	Rules  []DeviceCellularGatewayPortForwardingRulesRules `tfsdk:"rules"`
}

type DeviceCellularGatewayPortForwardingRulesRules struct {
...
func (data DeviceCellularGatewayPortForwardingRules) getPath() string {
...
func (data DeviceCellularGatewayPortForwardingRules) toBody(ctx context.Context, state DeviceCellularGatewayPortForwardingRules) string {
	body := ""
	{
...
func (data *DeviceCellularGatewayPortForwardingRules) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("rules"); value.Exists() && value.Value() != nil {
		data.Rules = make([]DeviceCellularGatewayPortForwardingRulesRules, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DeviceCellularGatewayPortForwardingRulesRules{}
...
func (data *DeviceCellularGatewayPortForwardingRules) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *DeviceCellularGatewayPortForwardingRules) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
