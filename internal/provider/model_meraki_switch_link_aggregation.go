...
func (data *SwitchLinkAggregation) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data SwitchLinkAggregation) addDeleteValues(ctx context.Context, body string) string {
	return body
}
