...
func (data *OrganizationSAML) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *OrganizationSAML) fromBodyPartial(ctx context.Context, res gjson.Result) {
