...
func TestAccDataSourceMerakiSwitchOrganizationPortsProfilesAutomation(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_switch_organization_ports_profiles_automation.test", "assigned_switch_ports.0.switch_port_ids.0", "3"))
