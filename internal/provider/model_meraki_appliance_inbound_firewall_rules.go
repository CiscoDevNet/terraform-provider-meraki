...
type ApplianceInboundFirewallRules struct {
	Id                types.String                         `tfsdk:"id"`
	NetworkId         types.String                         `tfsdk:"network_id"`
	SyslogDefaultRule types.Bool                           `tfsdk:"syslog_default_rule"`
	Rules             []ApplianceInboundFirewallRulesRules `tfsdk:"rules"`
}

type ApplianceInboundFirewallRulesRules struct {
...
func (data ApplianceInboundFirewallRules) getPath() string {
...
func (data ApplianceInboundFirewallRules) toBody(ctx context.Context, state ApplianceInboundFirewallRules) string {
	body := ""
...
func (data ApplianceInboundFirewallRules) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data *ApplianceInboundFirewallRules) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *ApplianceInboundFirewallRules) fromBodyPartial(ctx context.Context, res meraki.Res) {
	{
...
func (data *ApplianceInboundFirewallRules) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
