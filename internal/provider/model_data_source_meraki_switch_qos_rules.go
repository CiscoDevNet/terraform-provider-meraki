...
type DataSourceSwitchQoSRules struct {
	NetworkId types.String                    `tfsdk:"network_id"`
	Items     []DataSourceSwitchQoSRulesItems `tfsdk:"items"`
}

type DataSourceSwitchQoSRulesItems struct {
...
func (data DataSourceSwitchQoSRules) getPath() string {
...
func (data *DataSourceSwitchQoSRules) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceSwitchQoSRulesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceSwitchQoSRulesItems{}
