...
// It emits a separate model - DataSourceOrganizationBrandingPoliciesPriorities - used only by the data source, always including every
...
type DataSourceOrganizationBrandingPoliciesPriorities struct {
...
func (data DataSourceOrganizationBrandingPoliciesPriorities) getPath() string {
...
func (data *DataSourceOrganizationBrandingPoliciesPriorities) fromBody(ctx context.Context, res meraki.Res) {
