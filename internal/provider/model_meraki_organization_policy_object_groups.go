...
type OrganizationPolicyObjectGroups struct {
	OrganizationId types.String                          `tfsdk:"organization_id"`
	Items          []OrganizationPolicyObjectGroupsItems `tfsdk:"items"`
}

type OrganizationPolicyObjectGroupsItems struct {
...
func (data OrganizationPolicyObjectGroups) getPath() string {
...
func (data *OrganizationPolicyObjectGroups) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]OrganizationPolicyObjectGroupsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := OrganizationPolicyObjectGroupsItems{}
