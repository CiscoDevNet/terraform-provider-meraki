...
func TestAccMerakiOrganizationAuthRADIUSServer(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_organization_auth_radius_server.test", "address", "1.2.3.4"))
	checks = append(checks, resource.TestCheckResourceAttr("meraki_organization_auth_radius_server.test", "name", "HQ RADIUS server"))
	checks = append(checks, resource.TestCheckResourceAttr("meraki_organization_auth_radius_server.test", "modes.0.mode", "auth"))
...
func merakiOrganizationAuthRADIUSServerImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
const testAccMerakiOrganizationAuthRADIUSServerPrerequisitesConfig = `
variable "test_org" {}
...
func testAccMerakiOrganizationAuthRADIUSServerConfig_minimum() string {
