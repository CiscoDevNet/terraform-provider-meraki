...
// It emits a separate model - DataSourceOrganizationPolicyObject - used only by the data source, always including every
...
type DataSourceOrganizationPolicyObject struct {
...
func (data DataSourceOrganizationPolicyObject) getPath() string {
...
func (data *DataSourceOrganizationPolicyObject) fromBody(ctx context.Context, res meraki.Res) {
