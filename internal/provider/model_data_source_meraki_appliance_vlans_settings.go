...
// It emits a separate model - DataSourceApplianceVLANsSettings - used only by the data source, always including every
...
type DataSourceApplianceVLANsSettings struct {
...
func (data DataSourceApplianceVLANsSettings) getPath() string {
...
func (data *DataSourceApplianceVLANsSettings) fromBody(ctx context.Context, res meraki.Res) {
