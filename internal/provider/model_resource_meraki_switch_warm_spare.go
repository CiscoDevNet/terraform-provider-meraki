...
func (data SwitchWarmSpare) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data *SwitchWarmSpare) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data SwitchWarmSpare) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
