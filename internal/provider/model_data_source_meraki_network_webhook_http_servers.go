...
type DataSourceNetworkWebhookHTTPServers struct {
	NetworkId types.String                               `tfsdk:"network_id"`
	Items     []DataSourceNetworkWebhookHTTPServersItems `tfsdk:"items"`
}

type DataSourceNetworkWebhookHTTPServersItems struct {
...
func (data DataSourceNetworkWebhookHTTPServers) getPath() string {
...
func (data *DataSourceNetworkWebhookHTTPServers) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceNetworkWebhookHTTPServersItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceNetworkWebhookHTTPServersItems{}
