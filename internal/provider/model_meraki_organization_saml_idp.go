...
func (data *OrganizationSAMLIdP) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *OrganizationSAMLIdP) fromBodyPartial(ctx context.Context, res gjson.Result) {
