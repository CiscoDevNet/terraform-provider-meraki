...
// It emits a separate model - DataSourceApplianceOneToManyNATRules - used only by the data source, always including every
...
type DataSourceApplianceOneToManyNATRules struct {
	Id        types.String                                `tfsdk:"id"`
	NetworkId types.String                                `tfsdk:"network_id"`
	Rules     []DataSourceApplianceOneToManyNATRulesRules `tfsdk:"rules"`
}

type DataSourceApplianceOneToManyNATRulesRules struct {
	PublicIp  types.String                                         `tfsdk:"public_ip"`
	Uplink    types.String                                         `tfsdk:"uplink"`
	PortRules []DataSourceApplianceOneToManyNATRulesRulesPortRules `tfsdk:"port_rules"`
}

type DataSourceApplianceOneToManyNATRulesRulesPortRules struct {
...
func (data DataSourceApplianceOneToManyNATRules) getPath() string {
...
func (data *DataSourceApplianceOneToManyNATRules) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("rules"); value.Exists() && value.Value() != nil {
		data.Rules = make([]DataSourceApplianceOneToManyNATRulesRules, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceApplianceOneToManyNATRulesRules{}
			...
			if value := res.Get("portRules"); value.Exists() && value.Value() != nil {
				data.PortRules = make([]DataSourceApplianceOneToManyNATRulesRulesPortRules, 0)
				value.ForEach(func(k, res gjson.Result) bool {
					parent := &data
					data := DataSourceApplianceOneToManyNATRulesRulesPortRules{}
