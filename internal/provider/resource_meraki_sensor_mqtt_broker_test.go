...
func merakiSensorMQTTBrokerImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
const testAccMerakiSensorMQTTBrokerPrerequisitesConfig = `
variable "test_org" {}
...
func testAccMerakiSensorMQTTBrokerConfig_minimum() string {
