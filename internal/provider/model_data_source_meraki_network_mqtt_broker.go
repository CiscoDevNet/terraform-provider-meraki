...
// It emits a separate model - DataSourceNetworkMQTTBroker - used only by the data source, always including every
...
type DataSourceNetworkMQTTBroker struct {
...
func (data DataSourceNetworkMQTTBroker) getPath() string {
...
func (data *DataSourceNetworkMQTTBroker) fromBody(ctx context.Context, res meraki.Res) {
