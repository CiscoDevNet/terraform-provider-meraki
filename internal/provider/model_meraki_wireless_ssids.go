...
type WirelessSSIDs struct {
	...
	Items     []WirelessSSIDsItems `tfsdk:"items"`
}

type WirelessSSIDsItems struct {
	...
	RadiusAccountingServers         []WirelessSSIDsRadiusAccountingServers `tfsdk:"radius_accounting_servers"`
	RadiusServers                   []WirelessSSIDsRadiusServers           `tfsdk:"radius_servers"`
	WalledGardenRanges              types.List                             `tfsdk:"walled_garden_ranges"`
}

type WirelessSSIDsRadiusAccountingServers struct {
...
type WirelessSSIDsRadiusServers struct {
	CaCertificate            types.String `tfsdk:"ca_certificate"`
	Host                     types.String `tfsdk:"host"`
	OpenRoamingCertificateId types.Int64  `tfsdk:"open_roaming_certificate_id"`
	Port                     types.Int64  `tfsdk:"port"`
...
func (data WirelessSSIDs) getPath() string {
...
func (data *WirelessSSIDs) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]WirelessSSIDsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := WirelessSSIDsItems{}
		...
		if value := res.Get("radiusAccountingServers"); value.Exists() && value.Value() != nil {
			data.RadiusAccountingServers = make([]WirelessSSIDsRadiusAccountingServers, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := WirelessSSIDsRadiusAccountingServers{}
		...
		if value := res.Get("radiusServers"); value.Exists() && value.Value() != nil {
			data.RadiusServers = make([]WirelessSSIDsRadiusServers, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := WirelessSSIDsRadiusServers{}
				if value := res.Get("caCertificate"); value.Exists() && value.Value() != nil {
					data.CaCertificate = types.StringValue(value.String())
				} else {
					data.CaCertificate = types.StringNull()
