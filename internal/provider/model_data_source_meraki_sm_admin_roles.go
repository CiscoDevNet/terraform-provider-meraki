...
type DataSourceSMAdminRoles struct {
	OrganizationId types.String                  `tfsdk:"organization_id"`
	Items          []DataSourceSMAdminRolesItems `tfsdk:"items"`
}

type DataSourceSMAdminRolesItems struct {
...
func (data DataSourceSMAdminRoles) getPath() string {
...
func (data *DataSourceSMAdminRoles) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceSMAdminRolesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceSMAdminRolesItems{}
