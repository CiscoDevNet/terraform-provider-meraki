...
var (
	_ datasource.DataSource              = &OrganizationWirelessDevicesProvisioningDeploymentssDataSource{}
	_ datasource.DataSourceWithConfigure = &OrganizationWirelessDevicesProvisioningDeploymentssDataSource{}
)

func NewOrganizationWirelessDevicesProvisioningDeploymentssDataSource() datasource.DataSource {
	return &OrganizationWirelessDevicesProvisioningDeploymentssDataSource{}
}

type OrganizationWirelessDevicesProvisioningDeploymentssDataSource struct {
	client *meraki.Client
}

func (d *OrganizationWirelessDevicesProvisioningDeploymentssDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_organization_wireless_devices_provisioning_deploymentss"
}

func (d *OrganizationWirelessDevicesProvisioningDeploymentssDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Organization Wireless Devices Provisioning Deployments` configuration in bulk.").String,
...
func (d *OrganizationWirelessDevicesProvisioningDeploymentssDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *OrganizationWirelessDevicesProvisioningDeploymentssDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DataSourceOrganizationWirelessDevicesProvisioningDeploymentss
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Beginning Read", "OrganizationWirelessDevicesProvisioningDeploymentssDataSource"))
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Read finished successfully", "OrganizationWirelessDevicesProvisioningDeploymentssDataSource"))
