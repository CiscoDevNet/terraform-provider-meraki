...
func (data *WirelessDeviceBluetoothSettings) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *WirelessDeviceBluetoothSettings) fromBodyPartial(ctx context.Context, res gjson.Result) {
