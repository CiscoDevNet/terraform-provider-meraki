...
type SwitchDHCPServerPolicyARPInspectionTrustedServers struct {
	...
	Items     []SwitchDHCPServerPolicyARPInspectionTrustedServersItems `tfsdk:"items"`
}

type SwitchDHCPServerPolicyARPInspectionTrustedServersItems struct {
...
func (data SwitchDHCPServerPolicyARPInspectionTrustedServers) getPath() string {
...
func (data *SwitchDHCPServerPolicyARPInspectionTrustedServers) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]SwitchDHCPServerPolicyARPInspectionTrustedServersItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := SwitchDHCPServerPolicyARPInspectionTrustedServersItems{}
