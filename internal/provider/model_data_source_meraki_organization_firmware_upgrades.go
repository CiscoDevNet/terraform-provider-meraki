...
type DataSourceOrganizationFirmwareUpgrades struct {
	OrganizationId types.String                                  `tfsdk:"organization_id"`
	Items          []DataSourceOrganizationFirmwareUpgradesItems `tfsdk:"items"`
}

type DataSourceOrganizationFirmwareUpgradesItems struct {
...
func (data DataSourceOrganizationFirmwareUpgrades) getPath() string {
...
func (data *DataSourceOrganizationFirmwareUpgrades) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceOrganizationFirmwareUpgradesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceOrganizationFirmwareUpgradesItems{}
