...
// It emits a separate model - DataSourceWirelessRadioSettings - used only by the data source, always including every
...
type DataSourceWirelessRadioSettings struct {
...
func (data DataSourceWirelessRadioSettings) getPath() string {
...
func (data *DataSourceWirelessRadioSettings) fromBody(ctx context.Context, res meraki.Res) {
