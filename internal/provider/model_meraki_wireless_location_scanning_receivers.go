...
type WirelessLocationScanningReceivers struct {
	OrganizationId types.String                             `tfsdk:"organization_id"`
	Items          []WirelessLocationScanningReceiversItems `tfsdk:"items"`
}

type WirelessLocationScanningReceiversItems struct {
...
func (data WirelessLocationScanningReceivers) getPath() string {
...
func (data *WirelessLocationScanningReceivers) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]WirelessLocationScanningReceiversItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := WirelessLocationScanningReceiversItems{}
