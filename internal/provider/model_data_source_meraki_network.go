...
// It emits a separate model - DataSourceNetwork - used only by the data source, always including every
...
func (data DataSourceNetwork) getPath() string {
...
func (data *DataSourceNetwork) fromBody(ctx context.Context, res meraki.Res) {
