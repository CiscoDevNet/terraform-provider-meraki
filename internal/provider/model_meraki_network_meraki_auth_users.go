...
type NetworkMerakiAuthUsers struct {
	NetworkId types.String                  `tfsdk:"network_id"`
	Items     []NetworkMerakiAuthUsersItems `tfsdk:"items"`
}

type NetworkMerakiAuthUsersItems struct {
	...
	Authorizations      []NetworkMerakiAuthUsersAuthorizations `tfsdk:"authorizations"`
}

type NetworkMerakiAuthUsersAuthorizations struct {
...
func (data NetworkMerakiAuthUsers) getPath() string {
...
func (data *NetworkMerakiAuthUsers) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]NetworkMerakiAuthUsersItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := NetworkMerakiAuthUsersItems{}
		...
		if value := res.Get("authorizations"); value.Exists() && value.Value() != nil {
			data.Authorizations = make([]NetworkMerakiAuthUsersAuthorizations, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := NetworkMerakiAuthUsersAuthorizations{}
