...
var (
	_ datasource.DataSource              = &SwitchOrganizationPortsProfilesDataSource{}
	_ datasource.DataSourceWithConfigure = &SwitchOrganizationPortsProfilesDataSource{}
)

func NewSwitchOrganizationPortsProfilesDataSource() datasource.DataSource {
	return &SwitchOrganizationPortsProfilesDataSource{}
}

type SwitchOrganizationPortsProfilesDataSource struct {
	client *meraki.Client
}

func (d *SwitchOrganizationPortsProfilesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_switch_organization_ports_profiles"
}

func (d *SwitchOrganizationPortsProfilesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Switch Organization Ports Profile` configuration in bulk.").AddEarlyAccessDescription().String,
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"authentication_host_mode": schema.StringAttribute{
							MarkdownDescription: "The host mode override for RADIUS-based port profile application. Supported values are `single-host` and `multi-host`.",
							Computed:            true,
						},
...
func (d *SwitchOrganizationPortsProfilesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *SwitchOrganizationPortsProfilesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DataSourceSwitchOrganizationPortsProfiles
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Beginning Read", "SwitchOrganizationPortsProfilesDataSource"))
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Read finished successfully", "SwitchOrganizationPortsProfilesDataSource"))
