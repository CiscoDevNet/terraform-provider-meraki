...
// It emits a separate model - DataSourceWirelessDeviceElectronicShelfLabel - used only by the data source, always including every
...
type DataSourceWirelessDeviceElectronicShelfLabel struct {
...
func (data DataSourceWirelessDeviceElectronicShelfLabel) getPath() string {
...
func (data *DataSourceWirelessDeviceElectronicShelfLabel) fromBody(ctx context.Context, res meraki.Res) {
