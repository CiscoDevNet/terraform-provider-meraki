...
var (
	_ datasource.DataSource              = &OrganizationSAMLIdPDataSource{}
	_ datasource.DataSourceWithConfigure = &OrganizationSAMLIdPDataSource{}
)

func NewOrganizationSAMLIdPDataSource() datasource.DataSource {
	return &OrganizationSAMLIdPDataSource{}
}

type OrganizationSAMLIdPDataSource struct {
	client *meraki.Client
}

func (d *OrganizationSAMLIdPDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_organization_saml_idp"
}

func (d *OrganizationSAMLIdPDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *OrganizationSAMLIdPDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
