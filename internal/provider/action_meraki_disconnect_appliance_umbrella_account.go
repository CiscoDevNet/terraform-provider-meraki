...
var (
	_ action.Action              = &DisconnectApplianceUmbrellaAccountAction{}
	_ action.ActionWithConfigure = &DisconnectApplianceUmbrellaAccountAction{}
)

func NewDisconnectApplianceUmbrellaAccountAction() action.Action {
	return &DisconnectApplianceUmbrellaAccountAction{}
}

type DisconnectApplianceUmbrellaAccountAction struct {
	client *meraki.Client
}

func (a *DisconnectApplianceUmbrellaAccountAction) Metadata(ctx context.Context, req action.MetadataRequest, resp *action.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_disconnect_appliance_umbrella_account"
}
...
func (a *DisconnectApplianceUmbrellaAccountAction) Schema(ctx context.Context, req action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This action can invoke the `Disconnect Appliance Umbrella Account` operation.").String,
...
func (a *DisconnectApplianceUmbrellaAccountAction) Configure(_ context.Context, req action.ConfigureRequest, resp *action.ConfigureResponse) {
...
func (a *DisconnectApplianceUmbrellaAccountAction) Invoke(ctx context.Context, req action.InvokeRequest, resp *action.InvokeResponse) {
	var config ActionDisconnectApplianceUmbrellaAccount
