...
var (
	_ datasource.DataSource              = &SensorAlertsProfilesDataSource{}
	_ datasource.DataSourceWithConfigure = &SensorAlertsProfilesDataSource{}
)

func NewSensorAlertsProfilesDataSource() datasource.DataSource {
	return &SensorAlertsProfilesDataSource{}
}

type SensorAlertsProfilesDataSource struct {
	client *meraki.Client
}

func (d *SensorAlertsProfilesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *SensorAlertsProfilesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *SensorAlertsProfilesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Beginning Read", "SensorAlertsProfilesDataSource"))
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Read finished successfully", "SensorAlertsProfilesDataSource"))
