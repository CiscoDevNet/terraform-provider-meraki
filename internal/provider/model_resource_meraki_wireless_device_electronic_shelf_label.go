...
func (data WirelessDeviceElectronicShelfLabel) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data WirelessDeviceElectronicShelfLabel) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
