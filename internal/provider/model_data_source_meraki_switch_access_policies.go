...
type DataSourceSwitchAccessPolicies struct {
	NetworkId types.String                          `tfsdk:"network_id"`
	Items     []DataSourceSwitchAccessPoliciesItems `tfsdk:"items"`
}

type DataSourceSwitchAccessPoliciesItems struct {
	...
	RadiusAccountingServers              []DataSourceSwitchAccessPoliciesRadiusAccountingServers `tfsdk:"radius_accounting_servers"`
	RadiusServers                        []DataSourceSwitchAccessPoliciesRadiusServers           `tfsdk:"radius_servers"`
	UrlRedirectWalledGardenRanges        types.Set                                               `tfsdk:"url_redirect_walled_garden_ranges"`
}

type DataSourceSwitchAccessPoliciesRadiusAccountingServers struct {
...
type DataSourceSwitchAccessPoliciesRadiusServers struct {
	Host                       types.String `tfsdk:"host"`
	OrganizationRadiusServerId types.String `tfsdk:"organization_radius_server_id"`
	Port                       types.Int64  `tfsdk:"port"`
	Secret                     types.String `tfsdk:"secret"`
...
func (data DataSourceSwitchAccessPolicies) getPath() string {
...
func (data *DataSourceSwitchAccessPolicies) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceSwitchAccessPoliciesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceSwitchAccessPoliciesItems{}
		...
		if value := res.Get("radiusAccountingServers"); value.Exists() && value.Value() != nil {
			data.RadiusAccountingServers = make([]DataSourceSwitchAccessPoliciesRadiusAccountingServers, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := DataSourceSwitchAccessPoliciesRadiusAccountingServers{}
		...
		if value := res.Get("radiusServers"); value.Exists() && value.Value() != nil {
			data.RadiusServers = make([]DataSourceSwitchAccessPoliciesRadiusServers, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := DataSourceSwitchAccessPoliciesRadiusServers{}
				if value := res.Get("host"); value.Exists() && value.Value() != nil {
					data.Host = types.StringValue(value.String())
				} else {
					data.Host = types.StringNull()
