...
type DataSourceApplianceStaticRoutes struct {
	NetworkId types.String                           `tfsdk:"network_id"`
	Items     []DataSourceApplianceStaticRoutesItems `tfsdk:"items"`
}
...
func (data DataSourceApplianceStaticRoutes) getPath() string {
...
func (data *DataSourceApplianceStaticRoutes) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceApplianceStaticRoutesItems, 0)
