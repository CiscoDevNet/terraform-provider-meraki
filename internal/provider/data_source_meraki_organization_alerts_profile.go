...
var (
	_ datasource.DataSource              = &OrganizationAlertsProfileDataSource{}
	_ datasource.DataSourceWithConfigure = &OrganizationAlertsProfileDataSource{}
)

func NewOrganizationAlertsProfileDataSource() datasource.DataSource {
	return &OrganizationAlertsProfileDataSource{}
}

type OrganizationAlertsProfileDataSource struct {
	client *meraki.Client
}

func (d *OrganizationAlertsProfileDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_organization_alerts_profile"
}

func (d *OrganizationAlertsProfileDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the `Organization Alerts Profile` configuration.",
...
func (d *OrganizationAlertsProfileDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
