...
type SwitchStackRoutingInterfaces struct {
	NetworkId     types.String                        `tfsdk:"network_id"`
	SwitchStackId types.String                        `tfsdk:"switch_stack_id"`
	Items         []SwitchStackRoutingInterfacesItems `tfsdk:"items"`
}

type SwitchStackRoutingInterfacesItems struct {
...
func (data SwitchStackRoutingInterfaces) getPath() string {
...
func (data *SwitchStackRoutingInterfaces) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]SwitchStackRoutingInterfacesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := SwitchStackRoutingInterfacesItems{}
