...
// It emits a separate model - DataSourceApplianceSettings - used only by the data source, always including every
...
type DataSourceApplianceSettings struct {
...
func (data DataSourceApplianceSettings) getPath() string {
...
func (data *DataSourceApplianceSettings) fromBody(ctx context.Context, res meraki.Res) {
