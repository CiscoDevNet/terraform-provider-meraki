...
type DataSourceApplianceRFProfiles struct {
	NetworkId types.String                         `tfsdk:"network_id"`
	Items     []DataSourceApplianceRFProfilesItems `tfsdk:"items"`
}

type DataSourceApplianceRFProfilesItems struct {
...
func (data DataSourceApplianceRFProfiles) getPath() string {
...
func (data *DataSourceApplianceRFProfiles) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceApplianceRFProfilesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceApplianceRFProfilesItems{}
