...
func (data *OrganizationPolicyObject) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *OrganizationPolicyObject) fromBodyPartial(ctx context.Context, res gjson.Result) {
