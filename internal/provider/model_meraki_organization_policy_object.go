...
type OrganizationPolicyObjectIdentity struct {
	OrganizationId types.String `tfsdk:"organization_id"`
	Id             types.String `tfsdk:"id"`
}
...
func (data OrganizationPolicyObject) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
	if value := res.Get("category"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "category", "null")
		} else {
			body, _ = sjson.Set(body, "category", value.String())
		}
	}
	...
	if value := res.Get("fqdn"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "fqdn", "null")
		} else {
			body, _ = sjson.Set(body, "fqdn", value.String())
		}
	}
	...
	if value := res.Get("mask"); value.Exists() {
		if value.Value() == nil {
			...
			body, _ = sjson.Set(body, "mask", value.String())
		}
	}
	...
	if value := res.Get("groupIds"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "groupIds", "null")
		} else {
			var values []string
...
func (data *OrganizationPolicyObject) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data *OrganizationPolicyObjectIdentity) toIdentity(ctx context.Context, plan *OrganizationPolicyObject) {
...
func (data *OrganizationPolicyObject) fromIdentity(ctx context.Context, identity *OrganizationPolicyObjectIdentity) {
...
func (data OrganizationPolicyObject) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
