...
// It emits a separate model - DataSourceSwitchAccessPolicy - used only by the data source, always including every
...
type DataSourceSwitchAccessPolicy struct {
	...
	RadiusAccountingServers              []DataSourceSwitchAccessPolicyRadiusAccountingServers `tfsdk:"radius_accounting_servers"`
	RadiusServers                        []DataSourceSwitchAccessPolicyRadiusServers           `tfsdk:"radius_servers"`
	UrlRedirectWalledGardenRanges        types.Set                                             `tfsdk:"url_redirect_walled_garden_ranges"`
}

type DataSourceSwitchAccessPolicyRadiusAccountingServers struct {
...
type DataSourceSwitchAccessPolicyRadiusServers struct {
	Host                       types.String `tfsdk:"host"`
	OrganizationRadiusServerId types.String `tfsdk:"organization_radius_server_id"`
	Port                       types.Int64  `tfsdk:"port"`
	Secret                     types.String `tfsdk:"secret"`
...
func (data DataSourceSwitchAccessPolicy) getPath() string {
...
func (data *DataSourceSwitchAccessPolicy) fromBody(ctx context.Context, res meraki.Res) {
	...
	if value := res.Get("radiusAccountingServers"); value.Exists() && value.Value() != nil {
		data.RadiusAccountingServers = make([]DataSourceSwitchAccessPolicyRadiusAccountingServers, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchAccessPolicyRadiusAccountingServers{}
	...
	if value := res.Get("radiusServers"); value.Exists() && value.Value() != nil {
		data.RadiusServers = make([]DataSourceSwitchAccessPolicyRadiusServers, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchAccessPolicyRadiusServers{}
			if value := res.Get("host"); value.Exists() && value.Value() != nil {
				data.Host = types.StringValue(value.String())
			} else {
				data.Host = types.StringNull()
