...
// It emits a separate model - DataSourceApplianceDNSSplitProfile - used only by the data source, always including every
...
type DataSourceApplianceDNSSplitProfile struct {
...
func (data DataSourceApplianceDNSSplitProfile) getPath() string {
...
func (data *DataSourceApplianceDNSSplitProfile) fromBody(ctx context.Context, res meraki.Res) {
