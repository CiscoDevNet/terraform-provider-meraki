...
type DataSourceSwitchStackRoutingStaticRoutes struct {
	NetworkId     types.String                                    `tfsdk:"network_id"`
	SwitchStackId types.String                                    `tfsdk:"switch_stack_id"`
	Items         []DataSourceSwitchStackRoutingStaticRoutesItems `tfsdk:"items"`
}

type DataSourceSwitchStackRoutingStaticRoutesItems struct {
...
func (data DataSourceSwitchStackRoutingStaticRoutes) getPath() string {
...
func (data *DataSourceSwitchStackRoutingStaticRoutes) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceSwitchStackRoutingStaticRoutesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceSwitchStackRoutingStaticRoutesItems{}
