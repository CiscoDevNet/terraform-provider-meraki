...
// It emits a separate model - DataSourceSwitchPort - used only by the data source, always including every
...
type DataSourceSwitchPort struct {
...
func (data DataSourceSwitchPort) getPath() string {
...
func (data *DataSourceSwitchPort) fromBody(ctx context.Context, res meraki.Res) {
