...
func (data *ApplianceUplinksSettings) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data ApplianceUplinksSettings) addDeleteValues(ctx context.Context, body string) string {
	return body
}
