...
type NetworkCellularGatewayConnectivityMonitoringDestinations struct {
	Id           types.String                                                           `tfsdk:"id"`
	NetworkId    types.String                                                           `tfsdk:"network_id"`
	Destinations []NetworkCellularGatewayConnectivityMonitoringDestinationsDestinations `tfsdk:"destinations"`
}

type NetworkCellularGatewayConnectivityMonitoringDestinationsDestinations struct {
...
func (data NetworkCellularGatewayConnectivityMonitoringDestinations) getPath() string {
...
func (data NetworkCellularGatewayConnectivityMonitoringDestinations) toBody(ctx context.Context, state NetworkCellularGatewayConnectivityMonitoringDestinations) string {
	body := ""
	{
...
func (data *NetworkCellularGatewayConnectivityMonitoringDestinations) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("destinations"); value.Exists() && value.Value() != nil {
		data.Destinations = make([]NetworkCellularGatewayConnectivityMonitoringDestinationsDestinations, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := NetworkCellularGatewayConnectivityMonitoringDestinationsDestinations{}
...
func (data *NetworkCellularGatewayConnectivityMonitoringDestinations) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *NetworkCellularGatewayConnectivityMonitoringDestinations) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
