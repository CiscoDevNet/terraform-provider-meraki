...
// It emits a separate model - DataSourceSwitchLinkAggregation - used only by the data source, always including every
...
type DataSourceSwitchLinkAggregation struct {
	Id                 types.String                                        `tfsdk:"id"`
	NetworkId          types.String                                        `tfsdk:"network_id"`
	SwitchPorts        []DataSourceSwitchLinkAggregationSwitchPorts        `tfsdk:"switch_ports"`
	SwitchProfilePorts []DataSourceSwitchLinkAggregationSwitchProfilePorts `tfsdk:"switch_profile_ports"`
}

type DataSourceSwitchLinkAggregationSwitchPorts struct {
	PortId types.String `tfsdk:"port_id"`
	Serial types.String `tfsdk:"serial"`
}

type DataSourceSwitchLinkAggregationSwitchProfilePorts struct {
	PortId  types.String `tfsdk:"port_id"`
...
func (data DataSourceSwitchLinkAggregation) getPath() string {
...
func (data *DataSourceSwitchLinkAggregation) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("switchPorts"); value.Exists() && value.Value() != nil {
		data.SwitchPorts = make([]DataSourceSwitchLinkAggregationSwitchPorts, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchLinkAggregationSwitchPorts{}
	...
	if value := res.Get("switchProfilePorts"); value.Exists() && value.Value() != nil {
		data.SwitchProfilePorts = make([]DataSourceSwitchLinkAggregationSwitchProfilePorts, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchLinkAggregationSwitchProfilePorts{}
			if value := res.Get("portId"); value.Exists() && value.Value() != nil {
				data.PortId = types.StringValue(value.String())
			} else {
				data.PortId = types.StringNull()
