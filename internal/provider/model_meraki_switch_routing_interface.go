...
func (data *SwitchRoutingInterface) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *SwitchRoutingInterface) fromBodyPartial(ctx context.Context, res gjson.Result) {
