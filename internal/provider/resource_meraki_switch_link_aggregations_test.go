...
func merakiSwitchLinkAggregationsImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
const testAccMerakiSwitchLinkAggregationsPrerequisitesConfig = `
variable "test_org" {}
...
func testAccMerakiSwitchLinkAggregationsConfig_minimum() string {
	config := `resource "meraki_switch_link_aggregations" "test" {` + "\n"
...
func testAccMerakiSwitchLinkAggregationsConfig_all() string {
	config := `resource "meraki_switch_link_aggregations" "test" {` + "\n"
	config += ` network_id = meraki_network.test.id` + "\n"
	config += ` organization_id = data.meraki_organization.test.id` + "\n"
	config += ` items = [{` + "\n"
