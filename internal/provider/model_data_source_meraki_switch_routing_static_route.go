...
// It emits a separate model - DataSourceSwitchRoutingStaticRoute - used only by the data source, always including every
...
type DataSourceSwitchRoutingStaticRoute struct {
...
func (data DataSourceSwitchRoutingStaticRoute) getPath() string {
...
func (data *DataSourceSwitchRoutingStaticRoute) fromBody(ctx context.Context, res meraki.Res) {
