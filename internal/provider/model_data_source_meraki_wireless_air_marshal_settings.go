...
// It emits a separate model - DataSourceWirelessAirMarshalSettings - used only by the data source, always including every
...
type DataSourceWirelessAirMarshalSettings struct {
...
func (data DataSourceWirelessAirMarshalSettings) getPath() string {
...
func (data *DataSourceWirelessAirMarshalSettings) fromBody(ctx context.Context, res meraki.Res) {
