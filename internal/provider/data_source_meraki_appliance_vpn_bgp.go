...
func (d *ApplianceVPNBGPDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Appliance VPN BGP` configuration.").String,
		...
		Attributes: map[string]schema.Attribute{
			...
			"router_id": schema.StringAttribute{
				MarkdownDescription: "The router ID of the appliance",
				Computed:            true,
			},
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"weight": schema.Int64Attribute{
							MarkdownDescription: "Sets the local weight for routes received from the remote peer. Routes from peers with higher weights will be preferred. Must be an integer between 0 and 49.",
							Computed:            true,
						},
						...
						"community_out": schema.ListAttribute{
							MarkdownDescription: "List of BGP communities tagged to the routes advertised to an eBGP neighbor.",
							ElementType:         types.StringType,
							Computed:            true,
						},
						"filter_in": schema.ListAttribute{
							MarkdownDescription: "Filters routes received from an eBGP neighbor. Each entry must be an IPv4 CIDR string (e.g., `10.0.0.0/8` or `10.0.0.5/32`).",
							ElementType:         types.StringType,
							Computed:            true,
						},
