...
type DataSourceWirelessSSIDIdentityPSKs struct {
	NetworkId types.String                              `tfsdk:"network_id"`
	Number    types.String                              `tfsdk:"number"`
	Items     []DataSourceWirelessSSIDIdentityPSKsItems `tfsdk:"items"`
}

type DataSourceWirelessSSIDIdentityPSKsItems struct {
...
func (data DataSourceWirelessSSIDIdentityPSKs) getPath() string {
...
func (data *DataSourceWirelessSSIDIdentityPSKs) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceWirelessSSIDIdentityPSKsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceWirelessSSIDIdentityPSKsItems{}
