...
type SwitchRoutingMulticastRendezvousPoints struct {
	...
	Items     []SwitchRoutingMulticastRendezvousPointsItems `tfsdk:"items"`
}

type SwitchRoutingMulticastRendezvousPointsItems struct {
...
func (data SwitchRoutingMulticastRendezvousPoints) getPath() string {
...
func (data *SwitchRoutingMulticastRendezvousPoints) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]SwitchRoutingMulticastRendezvousPointsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := SwitchRoutingMulticastRendezvousPointsItems{}
