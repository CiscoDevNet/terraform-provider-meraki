...
type OrganizationEarlyAccessFeatures struct {
	OrganizationId types.String                           `tfsdk:"organization_id"`
	Items          []OrganizationEarlyAccessFeaturesItems `tfsdk:"items"`
}

type OrganizationEarlyAccessFeaturesItems struct {
...
func (data OrganizationEarlyAccessFeatures) getPath() string {
...
func (data *OrganizationEarlyAccessFeatures) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]OrganizationEarlyAccessFeaturesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := OrganizationEarlyAccessFeaturesItems{}
