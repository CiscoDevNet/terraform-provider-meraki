...
func (data ApplianceFirewalledService) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data *ApplianceFirewalledService) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
