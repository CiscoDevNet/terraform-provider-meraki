...
var (
	_ datasource.DataSource              = &SwitchRoutingInterfaceDHCPDataSource{}
	_ datasource.DataSourceWithConfigure = &SwitchRoutingInterfaceDHCPDataSource{}
)

func NewSwitchRoutingInterfaceDHCPDataSource() datasource.DataSource {
	return &SwitchRoutingInterfaceDHCPDataSource{}
}

type SwitchRoutingInterfaceDHCPDataSource struct {
	client *meraki.Client
}

func (d *SwitchRoutingInterfaceDHCPDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_switch_routing_interface_dhcp"
}

func (d *SwitchRoutingInterfaceDHCPDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Switch Routing Interface DHCP` configuration.").String,
...
func (d *SwitchRoutingInterfaceDHCPDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
