...
// It emits a separate model - DataSourceSwitchOrganizationPortsProfile - used only by the data source, always including every
...
type DataSourceSwitchOrganizationPortsProfile struct {
	...
	NetworksValues                 []DataSourceSwitchOrganizationPortsProfileNetworksValues `tfsdk:"networks_values"`
...
type DataSourceSwitchOrganizationPortsProfileNetworksValues struct {
	Id   types.String `tfsdk:"id"`
	Name types.String `tfsdk:"name"`
}
...
func (data DataSourceSwitchOrganizationPortsProfile) getPath() string {
...
func (data *DataSourceSwitchOrganizationPortsProfile) fromBody(ctx context.Context, res meraki.Res) {
	...
	if value := res.Get("networks.values"); value.Exists() && value.Value() != nil {
		data.NetworksValues = make([]DataSourceSwitchOrganizationPortsProfileNetworksValues, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchOrganizationPortsProfileNetworksValues{}
