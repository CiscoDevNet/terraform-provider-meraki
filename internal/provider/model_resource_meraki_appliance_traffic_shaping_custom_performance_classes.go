...
type ResourceApplianceTrafficShapingCustomPerformanceClassesIdentity struct {
	OrganizationId types.String `tfsdk:"organization_id"`
	NetworkId      types.String `tfsdk:"network_id"`
...
func (data *ResourceApplianceTrafficShapingCustomPerformanceClasses) fromIdentity(ctx context.Context, identity *ResourceApplianceTrafficShapingCustomPerformanceClassesIdentity) {
