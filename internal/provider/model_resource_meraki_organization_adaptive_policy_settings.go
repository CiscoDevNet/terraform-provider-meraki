...
func (data OrganizationAdaptivePolicySettings) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
	if value := res.Get("enabledNetworks"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "enabledNetworks", "null")
		} else {
			var values []string
...
func (data *OrganizationAdaptivePolicySettings) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *OrganizationAdaptivePolicySettings) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *OrganizationAdaptivePolicySettings) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data OrganizationAdaptivePolicySettings) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
