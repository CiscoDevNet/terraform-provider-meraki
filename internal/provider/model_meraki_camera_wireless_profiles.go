...
type CameraWirelessProfiles struct {
	...
	Items     []CameraWirelessProfilesItems `tfsdk:"items"`
}

type CameraWirelessProfilesItems struct {
...
func (data CameraWirelessProfiles) getPath() string {
...
func (data *CameraWirelessProfiles) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]CameraWirelessProfilesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := CameraWirelessProfilesItems{}
