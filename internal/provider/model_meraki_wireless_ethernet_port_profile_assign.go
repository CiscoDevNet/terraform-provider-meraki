...
type WirelessEthernetPortProfileAssign struct {
...
func (data WirelessEthernetPortProfileAssign) getPath() string {
	return fmt.Sprintf("/networks/%v/wireless/ethernet/ports/profiles/assign", url.QueryEscape(data.NetworkId.ValueString()))
}
...
func (data WirelessEthernetPortProfileAssign) toBody(ctx context.Context, state WirelessEthernetPortProfileAssign) string {
	body := ""
...
func (data WirelessEthernetPortProfileAssign) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data *WirelessEthernetPortProfileAssign) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data WirelessEthernetPortProfileAssign) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
