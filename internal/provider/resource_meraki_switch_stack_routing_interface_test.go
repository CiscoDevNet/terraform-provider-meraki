...
func TestAccMerakiSwitchStackRoutingInterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_switch_stack_routing_interface.test", "is_switch_default_gateway", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_switch_stack_routing_interface.test", "ipv6_is_switch_default_gateway", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_switch_stack_routing_interface.test", "vrf_name", "Default"))
