...
func TestAccDataSourceMerakiApplianceSiteToSiteVPN(t *testing.T) {
	...
	if os.Getenv("APPLIANCE_VPN_HOST_TRANSLATIONS") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("data.meraki_appliance_site_to_site_vpn.test", "host_translations.0.name", "Host 1"))
		checks = append(checks, resource.TestCheckResourceAttr("data.meraki_appliance_site_to_site_vpn.test", "host_translations.0.local_address", "192.168.1.10"))
		checks = append(checks, resource.TestCheckResourceAttr("data.meraki_appliance_site_to_site_vpn.test", "host_translations.0.remote_address", "72.168.2.10"))
	}
