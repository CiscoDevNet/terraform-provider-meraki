...
type ResourceSwitchStackRoutingInterfacesIdentity struct {
	OrganizationId types.String `tfsdk:"organization_id"`
	NetworkId      types.String `tfsdk:"network_id"`
	SwitchStackId  types.String `tfsdk:"switch_stack_id"`
...
func (data *ResourceSwitchStackRoutingInterfacesIdentity) toIdentity(ctx context.Context, plan *ResourceSwitchStackRoutingInterfaces) {
...
func (data *ResourceSwitchStackRoutingInterfaces) fromIdentity(ctx context.Context, identity *ResourceSwitchStackRoutingInterfacesIdentity) {
