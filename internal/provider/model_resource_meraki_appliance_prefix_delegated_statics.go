...
type ResourceAppliancePrefixDelegatedStaticsIdentity struct {
	OrganizationId types.String `tfsdk:"organization_id"`
	NetworkId      types.String `tfsdk:"network_id"`
...
func (data *ResourceAppliancePrefixDelegatedStatics) fromIdentity(ctx context.Context, identity *ResourceAppliancePrefixDelegatedStaticsIdentity) {
