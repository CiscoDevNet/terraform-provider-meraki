...
type SwitchOrganizationPortsProfiles struct {
	OrganizationId types.String                           `tfsdk:"organization_id"`
	Items          []SwitchOrganizationPortsProfilesItems `tfsdk:"items"`
}

type SwitchOrganizationPortsProfilesItems struct {
	...
	NetworksValues              []SwitchOrganizationPortsProfilesNetworksValues `tfsdk:"networks_values"`
...
type SwitchOrganizationPortsProfilesNetworksValues struct {
	Id   types.String `tfsdk:"id"`
	Name types.String `tfsdk:"name"`
}
...
func (data SwitchOrganizationPortsProfiles) getPath() string {
...
func (data *SwitchOrganizationPortsProfiles) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]SwitchOrganizationPortsProfilesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := SwitchOrganizationPortsProfilesItems{}
		...
		if value := res.Get("networks.values"); value.Exists() && value.Value() != nil {
			data.NetworksValues = make([]SwitchOrganizationPortsProfilesNetworksValues, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := SwitchOrganizationPortsProfilesNetworksValues{}
