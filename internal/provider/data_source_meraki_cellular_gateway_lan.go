...
var (
	_ datasource.DataSource              = &CellularGatewayLANDataSource{}
	_ datasource.DataSourceWithConfigure = &CellularGatewayLANDataSource{}
)

func NewCellularGatewayLANDataSource() datasource.DataSource {
	return &CellularGatewayLANDataSource{}
}

type CellularGatewayLANDataSource struct {
	client *meraki.Client
}

func (d *CellularGatewayLANDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cellular_gateway_lan"
}

func (d *CellularGatewayLANDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Cellular Gateway LAN` configuration.").String,
...
func (d *CellularGatewayLANDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
