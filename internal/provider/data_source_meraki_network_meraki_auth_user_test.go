...
func TestAccDataSourceMerakiNetworkMerakiAuthUser(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_network_meraki_auth_user.test", "email", "miles323@meraki.com"))
...
func testAccDataSourceMerakiNetworkMerakiAuthUserConfig() string {
	...
	config += `  email = "miles323@meraki.com"` + "\n"
