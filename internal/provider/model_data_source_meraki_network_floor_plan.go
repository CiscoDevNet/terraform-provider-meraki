...
// It emits a separate model - DataSourceNetworkFloorPlan - used only by the data source, always including every
...
type DataSourceNetworkFloorPlan struct {
...
func (data DataSourceNetworkFloorPlan) getPath() string {
...
func (data *DataSourceNetworkFloorPlan) fromBody(ctx context.Context, res meraki.Res) {
