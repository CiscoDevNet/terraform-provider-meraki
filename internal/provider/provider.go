...
func (p *MerakiProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewApplianceVPNSiteToSiteIPsecPeersSLAsResource,
		...
		NewNetworkResource,
		NewNetworkAlertsSettingsResource,
		...
		NewNetworkGroupPoliciesResource,
		...
		NewOrganizationAdaptivePolicyGroupsResource,
		...
		NewOrganizationExtensionsThousandEyesNetworkResource,
		NewOrganizationInventoryClaimResource,
		NewOrganizationLicenseResource,
		NewOrganizationLicensesResource,
		...
		NewOrganizationsWirelessDevicesProvisioningDeploymentsResource,
		...
		NewSMAdminRoleResource,
		NewSMAdminRolesResource,
		...
		NewSwitchRoutingInterfacesResource,
		...
		NewWirelessZigbeeResource,
		NewWirelessZigbeeDeviceResource,
		NewWirelessZigbeeDoorLockResource,
	}
}
...
func (p *MerakiProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewApplianceVPNSiteToSiteIPsecPeersSLAsDataSource,
		...
		NewNetworkAlertsSettingsDataSource,
		...
		NewOrganizationsIntegrationsDeployableDataSource,
		NewOrganizationsWirelessDevicesProvisioningDeploymentsDataSource,
		NewOrganizationsWirelessDevicesProvisioningDeploymentDataSource,
		NewRadioRRMByNetworkDataSource,
		NewSaseNetworksEligibleDataSource,
		...
		NewSMAdminRoleDataSource,
		NewSMAdminRolesDataSource,
		NewSMTargetGroupDataSource,
		NewSMTargetGroupsDataSource,
