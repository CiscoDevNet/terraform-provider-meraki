...
func (p *MerakiProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewDeviceResource,
		NewDeviceCellularGatewayLANResource,
		NewDeviceCellularGatewayPortForwardingRulesResource,
		NewDeviceCellularSIMsResource,
		NewDeviceManagementInterfaceResource,
		NewNetworkResource,
		NewNetworkCellularGatewayConnectivityMonitoringDestinationsResource,
		NewNetworkCellularGatewayDHCPResource,
		NewNetworkCellularGatewaySubnetPoolResource,
		NewNetworkCellularGatewayUplinkResource,
...
func (p *MerakiProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewDeviceDataSource,
		NewDeviceCellularGatewayLANDataSource,
		NewDeviceCellularGatewayPortForwardingRulesDataSource,
		NewDeviceCellularSIMsDataSource,
		NewDeviceManagementInterfaceDataSource,
		NewNetworkDataSource,
		NewNetworksDataSource,
		NewNetworkCellularGatewayConnectivityMonitoringDestinationsDataSource,
		NewNetworkCellularGatewayDHCPDataSource,
		NewNetworkCellularGatewaySubnetPoolDataSource,
		NewNetworkCellularGatewayUplinkDataSource,
