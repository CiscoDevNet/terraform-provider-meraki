...
// It emits a separate model - DataSourceSwitchRoutingMulticast - used only by the data source, always including every
...
type DataSourceSwitchRoutingMulticast struct {
	...
	Overrides                                          []DataSourceSwitchRoutingMulticastOverrides `tfsdk:"overrides"`
}

type DataSourceSwitchRoutingMulticastOverrides struct {
...
func (data DataSourceSwitchRoutingMulticast) getPath() string {
...
func (data *DataSourceSwitchRoutingMulticast) fromBody(ctx context.Context, res meraki.Res) {
	...
	if value := res.Get("overrides"); value.Exists() && value.Value() != nil {
		data.Overrides = make([]DataSourceSwitchRoutingMulticastOverrides, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchRoutingMulticastOverrides{}
