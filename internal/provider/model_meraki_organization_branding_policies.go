...
type OrganizationBrandingPolicies struct {
	OrganizationId types.String                        `tfsdk:"organization_id"`
	Items          []OrganizationBrandingPoliciesItems `tfsdk:"items"`
}

type OrganizationBrandingPoliciesItems struct {
...
func (data OrganizationBrandingPolicies) getPath() string {
...
func (data *OrganizationBrandingPolicies) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]OrganizationBrandingPoliciesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := OrganizationBrandingPoliciesItems{}
