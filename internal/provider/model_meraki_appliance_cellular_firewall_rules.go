...
func (data *ApplianceCellularFirewallRules) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ApplianceCellularFirewallRules) fromBodyPartial(ctx context.Context, res gjson.Result) {
	{
