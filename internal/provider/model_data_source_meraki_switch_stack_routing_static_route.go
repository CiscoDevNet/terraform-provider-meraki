...
// It emits a separate model - DataSourceSwitchStackRoutingStaticRoute - used only by the data source, always including every
...
type DataSourceSwitchStackRoutingStaticRoute struct {
...
func (data DataSourceSwitchStackRoutingStaticRoute) getPath() string {
...
func (data *DataSourceSwitchStackRoutingStaticRoute) fromBody(ctx context.Context, res meraki.Res) {
