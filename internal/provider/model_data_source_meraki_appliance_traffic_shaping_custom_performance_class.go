...
// It emits a separate model - DataSourceApplianceTrafficShapingCustomPerformanceClass - used only by the data source, always including every
...
type DataSourceApplianceTrafficShapingCustomPerformanceClass struct {
...
func (data DataSourceApplianceTrafficShapingCustomPerformanceClass) getPath() string {
...
func (data *DataSourceApplianceTrafficShapingCustomPerformanceClass) fromBody(ctx context.Context, res meraki.Res) {
