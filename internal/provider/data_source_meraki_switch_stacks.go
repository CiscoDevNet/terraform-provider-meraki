...
func (d *SwitchStacksDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Switch Stack` configuration in bulk.").String,
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"name": schema.StringAttribute{
							MarkdownDescription: "The name of the new stack",
							Computed:            true,
						},
						"serials": schema.SetAttribute{
							MarkdownDescription: "An array of switch serials to be added into the new stack",
...
func (d *SwitchStacksDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *SwitchStacksDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DataSourceSwitchStacks
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Beginning Read", "SwitchStacksDataSource"))
	...
	tflog.Debug(ctx, fmt.Sprintf("%s: Read finished successfully", "SwitchStacksDataSource"))
