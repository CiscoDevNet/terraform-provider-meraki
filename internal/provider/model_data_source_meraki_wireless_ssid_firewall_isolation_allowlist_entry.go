...
// It emits a separate model - DataSourceWirelessSSIDFirewallIsolationAllowlistEntry - used only by the data source, always including every
...
type DataSourceWirelessSSIDFirewallIsolationAllowlistEntry struct {
...
func (data DataSourceWirelessSSIDFirewallIsolationAllowlistEntry) getPath() string {
...
func (data *DataSourceWirelessSSIDFirewallIsolationAllowlistEntry) fromBody(ctx context.Context, res meraki.Res) {
