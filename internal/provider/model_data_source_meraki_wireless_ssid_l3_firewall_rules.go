...
// It emits a separate model - DataSourceWirelessSSIDL3FirewallRules - used only by the data source, always including every
...
type DataSourceWirelessSSIDL3FirewallRules struct {
	Id             types.String                                 `tfsdk:"id"`
	NetworkId      types.String                                 `tfsdk:"network_id"`
	Number         types.String                                 `tfsdk:"number"`
	AllowLanAccess types.Bool                                   `tfsdk:"allow_lan_access"`
	Rules          []DataSourceWirelessSSIDL3FirewallRulesRules `tfsdk:"rules"`
}

type DataSourceWirelessSSIDL3FirewallRulesRules struct {
...
func (data DataSourceWirelessSSIDL3FirewallRules) getPath() string {
...
func (data *DataSourceWirelessSSIDL3FirewallRules) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("rules"); value.Exists() && value.Value() != nil {
		data.Rules = make([]DataSourceWirelessSSIDL3FirewallRulesRules, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			...
			parent := &data
			data := DataSourceWirelessSSIDL3FirewallRulesRules{}
