...
type WirelessRadioSettingsIdentity struct {
	Serial types.String `tfsdk:"serial"`
}
...
func (data WirelessRadioSettings) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data *WirelessRadioSettings) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data *WirelessRadioSettingsIdentity) toIdentity(ctx context.Context, plan *WirelessRadioSettings) {
...
func (data *WirelessRadioSettings) fromIdentity(ctx context.Context, identity *WirelessRadioSettingsIdentity) {
...
func (data WirelessRadioSettings) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
