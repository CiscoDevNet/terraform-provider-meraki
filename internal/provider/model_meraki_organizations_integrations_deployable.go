...
type OrganizationsIntegrationsDeployable struct {
	...
	Items                    []OrganizationsIntegrationsDeployableItems `tfsdk:"items"`
}

type OrganizationsIntegrationsDeployableItems struct {
...
func (data OrganizationsIntegrationsDeployable) getPath() string {
...
func (data OrganizationsIntegrationsDeployable) toBody(ctx context.Context, state OrganizationsIntegrationsDeployable) string {
	body := ""
...
func (data *OrganizationsIntegrationsDeployable) fromBody(ctx context.Context, res meraki.Res) {
	...
	if value := res.Get("items"); value.Exists() && value.Value() != nil {
		data.Items = make([]OrganizationsIntegrationsDeployableItems, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := OrganizationsIntegrationsDeployableItems{}
...
func (data *OrganizationsIntegrationsDeployable) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *OrganizationsIntegrationsDeployable) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data OrganizationsIntegrationsDeployable) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
