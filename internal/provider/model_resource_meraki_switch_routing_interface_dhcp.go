...
func (data SwitchRoutingInterfaceDHCP) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data SwitchRoutingInterfaceDHCP) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
