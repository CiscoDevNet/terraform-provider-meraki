...
type OrganizationWirelessDevicesProvisioningDeploymentsIdentity struct {
	OrganizationId types.String `tfsdk:"organization_id"`
	Id             types.String `tfsdk:"id"`
}
...
func (data *OrganizationWirelessDevicesProvisioningDeploymentsIdentity) toIdentity(ctx context.Context, plan *OrganizationWirelessDevicesProvisioningDeployments) {
...
func (data *OrganizationWirelessDevicesProvisioningDeployments) fromIdentity(ctx context.Context, identity *OrganizationWirelessDevicesProvisioningDeploymentsIdentity) {
