...
func (data CellularGatewayDHCP) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data CellularGatewayDHCP) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
