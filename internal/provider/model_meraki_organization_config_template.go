...
type OrganizationConfigTemplateIdentity struct {
	OrganizationId types.String `tfsdk:"organization_id"`
	Id             types.String `tfsdk:"id"`
}
...
func (data OrganizationConfigTemplate) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data *OrganizationConfigTemplate) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *OrganizationConfigTemplate) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *OrganizationConfigTemplate) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data *OrganizationConfigTemplateIdentity) toIdentity(ctx context.Context, plan *OrganizationConfigTemplate) {
...
func (data *OrganizationConfigTemplate) fromIdentity(ctx context.Context, identity *OrganizationConfigTemplateIdentity) {
...
func (data OrganizationConfigTemplate) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
