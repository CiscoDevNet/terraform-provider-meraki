...
// It emits a separate model - DataSourceOrganizationConfigTemplate - used only by the data source, always including every
...
type DataSourceOrganizationConfigTemplate struct {
...
func (data DataSourceOrganizationConfigTemplate) getPath() string {
...
func (data *DataSourceOrganizationConfigTemplate) fromBody(ctx context.Context, res meraki.Res) {
