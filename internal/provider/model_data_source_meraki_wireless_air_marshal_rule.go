...
// It emits a separate model - DataSourceWirelessAirMarshalRule - used only by the data source, always including every
...
type DataSourceWirelessAirMarshalRule struct {
...
func (data DataSourceWirelessAirMarshalRule) getPath() string {
...
func (data *DataSourceWirelessAirMarshalRule) fromBody(ctx context.Context, res meraki.Res) {
