...
func TestAccDataSourceMerakiCameraQualityRetentionProfile(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_camera_quality_retention_profile.test", "video_settings_mv53_x_quality", "Standard"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_camera_quality_retention_profile.test", "video_settings_mv53_x_resolution", "1920x1080"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_camera_quality_retention_profile.test", "video_settings_mv84_x_quality", "Standard"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_camera_quality_retention_profile.test", "video_settings_mv84_x_resolution", "1440x1080"))
