...
// It emits a separate model - DataSourceCameraVideoSettings - used only by the data source, always including every
...
type DataSourceCameraVideoSettings struct {
...
func (data DataSourceCameraVideoSettings) getPath() string {
...
func (data *DataSourceCameraVideoSettings) fromBody(ctx context.Context, res meraki.Res) {
