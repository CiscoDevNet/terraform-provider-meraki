...
type DataSourceCameraQualityRetentionProfiles struct {
	NetworkId types.String                                    `tfsdk:"network_id"`
	Items     []DataSourceCameraQualityRetentionProfilesItems `tfsdk:"items"`
}

type DataSourceCameraQualityRetentionProfilesItems struct {
...
func (data DataSourceCameraQualityRetentionProfiles) getPath() string {
...
func (data *DataSourceCameraQualityRetentionProfiles) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceCameraQualityRetentionProfilesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceCameraQualityRetentionProfilesItems{}
