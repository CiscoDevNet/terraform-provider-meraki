...
// It emits a separate model - DataSourceSwitchPortSchedule - used only by the data source, always including every
...
type DataSourceSwitchPortSchedule struct {
...
func (data DataSourceSwitchPortSchedule) getPath() string {
...
func (data *DataSourceSwitchPortSchedule) fromBody(ctx context.Context, res meraki.Res) {
