...
func TestAccDataSourceMerakiSwitchRoutingStaticRoutes(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceMerakiSwitchRoutingStaticRoutesPrerequisitesConfig + testAccDataSourceMerakiSwitchRoutingStaticRoutesConfig(),
			},
		},
	})
}
...
const testAccDataSourceMerakiSwitchRoutingStaticRoutesPrerequisitesConfig = `
variable "test_org" {}
...
func testAccDataSourceMerakiSwitchRoutingStaticRoutesConfig() string {
	config := `data "meraki_switch_routing_static_routes" "test" {
