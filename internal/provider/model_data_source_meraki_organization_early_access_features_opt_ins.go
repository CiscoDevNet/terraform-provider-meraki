...
type DataSourceOrganizationEarlyAccessFeaturesOptIns struct {
	OrganizationId types.String                                           `tfsdk:"organization_id"`
	Items          []DataSourceOrganizationEarlyAccessFeaturesOptInsItems `tfsdk:"items"`
}

type DataSourceOrganizationEarlyAccessFeaturesOptInsItems struct {
...
func (data DataSourceOrganizationEarlyAccessFeaturesOptIns) getPath() string {
...
func (data *DataSourceOrganizationEarlyAccessFeaturesOptIns) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceOrganizationEarlyAccessFeaturesOptInsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceOrganizationEarlyAccessFeaturesOptInsItems{}
