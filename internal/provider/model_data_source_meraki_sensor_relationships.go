...
// It emits a separate model - DataSourceSensorRelationships - used only by the data source, always including every
...
type DataSourceSensorRelationships struct {
	Id                       types.String                                            `tfsdk:"id"`
	Serial                   types.String                                            `tfsdk:"serial"`
	LivestreamRelatedDevices []DataSourceSensorRelationshipsLivestreamRelatedDevices `tfsdk:"livestream_related_devices"`
}

type DataSourceSensorRelationshipsLivestreamRelatedDevices struct {
	Serial types.String `tfsdk:"serial"`
}
...
func (data DataSourceSensorRelationships) getPath() string {
...
func (data *DataSourceSensorRelationships) fromBody(ctx context.Context, res meraki.Res) {
	if value := res.Get("livestream.relatedDevices"); value.Exists() && value.Value() != nil {
		data.LivestreamRelatedDevices = make([]DataSourceSensorRelationshipsLivestreamRelatedDevices, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSensorRelationshipsLivestreamRelatedDevices{}
