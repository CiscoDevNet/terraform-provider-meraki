...
func TestAccDataSourceMerakiSwitchStackRoutingInterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_switch_stack_routing_interface.test", "static_v4_dns1", "8.8.8.8"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_switch_stack_routing_interface.test", "static_v4_dns2", "8.8.4.4"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_switch_stack_routing_interface.test", "uplink_v4", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_switch_stack_routing_interface.test", "uplink_v6", "true"))
