...
func (d *WirelessRadioRRMByNetworkDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Wireless Radio RRM By Network` configuration in bulk.").String,
			...
			"items": schema.SetNestedAttribute{
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"ai_rrm_enabled": schema.BoolAttribute{
							MarkdownDescription: "Toggle for enabling or disabling AI-RRM in a network",
							Computed:            true,
						},
						"ai_rrm_enablement_date": schema.StringAttribute{
							MarkdownDescription: "Time at which AI-RRM was last enabled in the network",
							Computed:            true,
						},
