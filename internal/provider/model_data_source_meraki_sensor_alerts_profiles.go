...
type DataSourceSensorAlertsProfiles struct {
	NetworkId types.String                          `tfsdk:"network_id"`
	Items     []DataSourceSensorAlertsProfilesItems `tfsdk:"items"`
}

type DataSourceSensorAlertsProfilesItems struct {
	...
	Conditions              []DataSourceSensorAlertsProfilesConditions `tfsdk:"conditions"`
	Serials                 types.List                                 `tfsdk:"serials"`
}

type DataSourceSensorAlertsProfilesConditions struct {
...
func (data DataSourceSensorAlertsProfiles) getPath() string {
...
func (data *DataSourceSensorAlertsProfiles) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceSensorAlertsProfilesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceSensorAlertsProfilesItems{}
		...
		if value := res.Get("conditions"); value.Exists() && value.Value() != nil {
			data.Conditions = make([]DataSourceSensorAlertsProfilesConditions, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := DataSourceSensorAlertsProfilesConditions{}
