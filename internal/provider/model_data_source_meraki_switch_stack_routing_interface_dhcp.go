...
// It emits a separate model - DataSourceSwitchStackRoutingInterfaceDHCP - used only by the data source, always including every
...
type DataSourceSwitchStackRoutingInterfaceDHCP struct {
	...
	DhcpOptions          []DataSourceSwitchStackRoutingInterfaceDHCPDhcpOptions        `tfsdk:"dhcp_options"`
	DhcpRelayServerIps   types.Set                                                     `tfsdk:"dhcp_relay_server_ips"`
	DnsCustomNameservers types.List                                                    `tfsdk:"dns_custom_nameservers"`
	FixedIpAssignments   []DataSourceSwitchStackRoutingInterfaceDHCPFixedIpAssignments `tfsdk:"fixed_ip_assignments"`
	ReservedIpRanges     []DataSourceSwitchStackRoutingInterfaceDHCPReservedIpRanges   `tfsdk:"reserved_ip_ranges"`
}

type DataSourceSwitchStackRoutingInterfaceDHCPDhcpOptions struct {
	Code  types.String `tfsdk:"code"`
	Type  types.String `tfsdk:"type"`
	Value types.String `tfsdk:"value"`
}

type DataSourceSwitchStackRoutingInterfaceDHCPFixedIpAssignments struct {
	Ip   types.String `tfsdk:"ip"`
	Mac  types.String `tfsdk:"mac"`
	Name types.String `tfsdk:"name"`
}

type DataSourceSwitchStackRoutingInterfaceDHCPReservedIpRanges struct {
...
func (data DataSourceSwitchStackRoutingInterfaceDHCP) getPath() string {
...
func (data *DataSourceSwitchStackRoutingInterfaceDHCP) fromBody(ctx context.Context, res meraki.Res) {
	...
	if value := res.Get("dhcpOptions"); value.Exists() && value.Value() != nil {
		data.DhcpOptions = make([]DataSourceSwitchStackRoutingInterfaceDHCPDhcpOptions, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchStackRoutingInterfaceDHCPDhcpOptions{}
	...
	if value := res.Get("fixedIpAssignments"); value.Exists() && value.Value() != nil {
		data.FixedIpAssignments = make([]DataSourceSwitchStackRoutingInterfaceDHCPFixedIpAssignments, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchStackRoutingInterfaceDHCPFixedIpAssignments{}
	...
	if value := res.Get("reservedIpRanges"); value.Exists() && value.Value() != nil {
		data.ReservedIpRanges = make([]DataSourceSwitchStackRoutingInterfaceDHCPReservedIpRanges, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchStackRoutingInterfaceDHCPReservedIpRanges{}
