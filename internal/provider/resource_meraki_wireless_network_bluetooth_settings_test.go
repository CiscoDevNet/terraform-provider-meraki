...
func TestAccMerakiWirelessNetworkBluetoothSettings(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		ResourceName:            "meraki_wireless_network_bluetooth_settings.test",
		ImportState:             true,
		ImportStateVerify:       true,
		ImportStateIdFunc:       merakiWirelessNetworkBluetoothSettingsImportStateIdFunc("meraki_wireless_network_bluetooth_settings.test"),
...
func merakiWirelessNetworkBluetoothSettingsImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
