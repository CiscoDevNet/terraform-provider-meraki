...
func TestAccMerakiOrganizationAdmin(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		ResourceName:            "meraki_organization_admin.test",
		ImportState:             true,
		ImportStateVerify:       true,
		ImportStateIdFunc:       merakiOrganizationAdminImportStateIdFunc("meraki_organization_admin.test"),
...
func merakiOrganizationAdminImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
