...
// It emits a separate model - DataSourceCameraDeviceWirelessProfiles - used only by the data source, always including every
...
type DataSourceCameraDeviceWirelessProfiles struct {
...
func (data DataSourceCameraDeviceWirelessProfiles) getPath() string {
...
func (data *DataSourceCameraDeviceWirelessProfiles) fromBody(ctx context.Context, res meraki.Res) {
