...
func TestAccDataSourceMerakiAppliancePorts(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceMerakiAppliancePortsPrerequisitesConfig + testAccDataSourceMerakiAppliancePortsConfig(),
			},
		},
	})
}
...
const testAccDataSourceMerakiAppliancePortsPrerequisitesConfig = `
variable "test_org" {}
...
func testAccDataSourceMerakiAppliancePortsConfig() string {
	config := `data "meraki_appliance_ports" "test" {
