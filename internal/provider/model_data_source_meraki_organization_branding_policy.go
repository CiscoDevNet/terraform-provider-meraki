...
// It emits a separate model - DataSourceOrganizationBrandingPolicy - used only by the data source, always including every
...
type DataSourceOrganizationBrandingPolicy struct {
...
func (data DataSourceOrganizationBrandingPolicy) getPath() string {
...
func (data *DataSourceOrganizationBrandingPolicy) fromBody(ctx context.Context, res meraki.Res) {
