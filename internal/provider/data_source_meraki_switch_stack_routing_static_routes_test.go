...
func TestAccDataSourceMerakiSwitchStackRoutingStaticRoutes(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceMerakiSwitchStackRoutingStaticRoutesPrerequisitesConfig + testAccDataSourceMerakiSwitchStackRoutingStaticRoutesConfig(),
			},
		},
	})
}
...
const testAccDataSourceMerakiSwitchStackRoutingStaticRoutesPrerequisitesConfig = `
variable "test_org" {}
...
func testAccDataSourceMerakiSwitchStackRoutingStaticRoutesConfig() string {
	config := `data "meraki_switch_stack_routing_static_routes" "test" {
			network_id = meraki_network.test.id
