...
type OrganizationPolicyObjectGroupIdentity struct {
	OrganizationId types.String `tfsdk:"organization_id"`
	Id             types.String `tfsdk:"id"`
}
...
func (data OrganizationPolicyObjectGroup) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
	...
	if value := res.Get("objectIds"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "objectIds", "null")
		} else {
			var values []int64
...
func (data *OrganizationPolicyObjectGroup) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data *OrganizationPolicyObjectGroupIdentity) toIdentity(ctx context.Context, plan *OrganizationPolicyObjectGroup) {
...
func (data *OrganizationPolicyObjectGroup) fromIdentity(ctx context.Context, identity *OrganizationPolicyObjectGroupIdentity) {
