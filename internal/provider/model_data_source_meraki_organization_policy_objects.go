...
type DataSourceOrganizationPolicyObjects struct {
	OrganizationId types.String                               `tfsdk:"organization_id"`
	Items          []DataSourceOrganizationPolicyObjectsItems `tfsdk:"items"`
}

type DataSourceOrganizationPolicyObjectsItems struct {
...
func (data DataSourceOrganizationPolicyObjects) getPath() string {
...
func (data *DataSourceOrganizationPolicyObjects) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceOrganizationPolicyObjectsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceOrganizationPolicyObjectsItems{}
