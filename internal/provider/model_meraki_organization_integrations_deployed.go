...
type OrganizationIntegrationsDeployedIdentity struct {
	OrganizationId types.String `tfsdk:"organization_id"`
}
...
func (data *OrganizationIntegrationsDeployedIdentity) toIdentity(ctx context.Context, plan *OrganizationIntegrationsDeployed) {
...
func (data *OrganizationIntegrationsDeployed) fromIdentity(ctx context.Context, identity *OrganizationIntegrationsDeployedIdentity) {
