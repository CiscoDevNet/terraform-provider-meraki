...
type OrganizationSaseNetworksEligible struct {
	...
	Items                    []OrganizationSaseNetworksEligibleItems `tfsdk:"items"`
}

type OrganizationSaseNetworksEligibleItems struct {
...
type OrganizationSaseNetworksEligibleIdentity struct {
	OrganizationId types.String `tfsdk:"organization_id"`
}
...
func (data OrganizationSaseNetworksEligible) getPath() string {
...
func (data OrganizationSaseNetworksEligible) toBody(ctx context.Context, state OrganizationSaseNetworksEligible) string {
	body := ""
...
func (data *OrganizationSaseNetworksEligible) fromBody(ctx context.Context, res meraki.Res) {
	...
	if value := res.Get("items"); value.Exists() && value.Value() != nil {
		data.Items = make([]OrganizationSaseNetworksEligibleItems, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := OrganizationSaseNetworksEligibleItems{}
...
func (data *OrganizationSaseNetworksEligible) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *OrganizationSaseNetworksEligible) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data *OrganizationSaseNetworksEligibleIdentity) toIdentity(ctx context.Context, plan *OrganizationSaseNetworksEligible) {
...
func (data *OrganizationSaseNetworksEligible) fromIdentity(ctx context.Context, identity *OrganizationSaseNetworksEligibleIdentity) {
...
func (data OrganizationSaseNetworksEligible) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
