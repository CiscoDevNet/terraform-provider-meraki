...
func (data Organization) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
	...
	if value := res.Get("management.details"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "management.details", "null")
		} else {
			body, _ = sjson.Set(body, "management.details", []interface{}{})
			parent := &body
			value.ForEach(func(k, res gjson.Result) bool {
				...
				*parent, _ = sjson.SetRaw(*parent, "management.details.-1", body)
				return true
			})
		}
	}
...
func (data *Organization) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *Organization) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *Organization) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
