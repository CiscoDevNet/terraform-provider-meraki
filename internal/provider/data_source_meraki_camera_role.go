...
var (
	_ datasource.DataSource              = &CameraRoleDataSource{}
	_ datasource.DataSourceWithConfigure = &CameraRoleDataSource{}
)

func NewCameraRoleDataSource() datasource.DataSource {
	return &CameraRoleDataSource{}
}

type CameraRoleDataSource struct {
	client *meraki.Client
}

func (d *CameraRoleDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_camera_role"
}

func (d *CameraRoleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *CameraRoleDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *CameraRoleDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *CameraRoleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DataSourceCameraRole
