...
func TestAccDataSourceMerakiDeviceManagementInterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_device_management_interface.test", "wan1_wan_enabled", "enabled"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_device_management_interface.test", "wan2_using_static_ip", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_device_management_interface.test", "wan2_vlan", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_device_management_interface.test", "wan2_wan_enabled", "enabled"))
