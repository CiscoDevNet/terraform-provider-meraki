...
// It emits a separate model - DataSourceSensorMQTTBroker - used only by the data source, always including every
...
type DataSourceSensorMQTTBroker struct {
...
func (data DataSourceSensorMQTTBroker) getPath() string {
...
func (data *DataSourceSensorMQTTBroker) fromBody(ctx context.Context, res meraki.Res) {
