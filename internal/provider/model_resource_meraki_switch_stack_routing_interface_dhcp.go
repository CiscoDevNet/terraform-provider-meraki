...
type SwitchStackRoutingInterfaceDHCP struct {
	...
	DhcpOptions          []SwitchStackRoutingInterfaceDHCPDhcpOptions        `tfsdk:"dhcp_options"`
	DhcpRelayServerIps   types.Set                                           `tfsdk:"dhcp_relay_server_ips"`
	DnsCustomNameservers types.List                                          `tfsdk:"dns_custom_nameservers"`
	FixedIpAssignments   []SwitchStackRoutingInterfaceDHCPFixedIpAssignments `tfsdk:"fixed_ip_assignments"`
	ReservedIpRanges     []SwitchStackRoutingInterfaceDHCPReservedIpRanges   `tfsdk:"reserved_ip_ranges"`
}

type SwitchStackRoutingInterfaceDHCPDhcpOptions struct {
	Code  types.String `tfsdk:"code"`
	Type  types.String `tfsdk:"type"`
	Value types.String `tfsdk:"value"`
}

type SwitchStackRoutingInterfaceDHCPFixedIpAssignments struct {
	Ip   types.String `tfsdk:"ip"`
	Mac  types.String `tfsdk:"mac"`
	Name types.String `tfsdk:"name"`
}

type SwitchStackRoutingInterfaceDHCPReservedIpRanges struct {
...
func (data SwitchStackRoutingInterfaceDHCP) getPath() string {
	return fmt.Sprintf("/networks/%v/switch/stacks/%v/routing/interfaces/%v/dhcp", url.QueryEscape(data.NetworkId.ValueString()), url.QueryEscape(data.SwitchStackId.ValueString()), url.QueryEscape(data.InterfaceId.ValueString()))
}
...
func (data SwitchStackRoutingInterfaceDHCP) toBody(ctx context.Context, state SwitchStackRoutingInterfaceDHCP) string {
	body := ""
...
func (data SwitchStackRoutingInterfaceDHCP) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
	if value := res.Get("bootFileName"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "bootFileName", "null")
		} else {
			body, _ = sjson.Set(body, "bootFileName", value.String())
		}
	}
	if value := res.Get("bootNextServer"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "bootNextServer", "null")
		} else {
			body, _ = sjson.Set(body, "bootNextServer", value.String())
		}
	}
	if value := res.Get("bootOptionsEnabled"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "bootOptionsEnabled", "null")
		} else {
			body, _ = sjson.Set(body, "bootOptionsEnabled", value.Bool())
		}
	}
	...
	if value := res.Get("dhcpMode"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "dhcpMode", "null")
		} else {
			body, _ = sjson.Set(body, "dhcpMode", value.String())
		}
	}
	if value := res.Get("dnsNameserversOption"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "dnsNameserversOption", "null")
		} else {
			body, _ = sjson.Set(body, "dnsNameserversOption", value.String())
		}
	}
	...
	if value := res.Get("dnsCustomNameservers"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "dnsCustomNameservers", "null")
		} else {
			var values []string
			for _, v := range value.Array() {
				values = append(values, v.String())
		...
		if value.Value() == nil {
			...
			value.ForEach(func(k, res gjson.Result) bool {
				...
				if value := res.Get("mac"); value.Exists() {
					if value.Value() == nil {
						body, _ = sjson.SetRaw(body, "mac", "null")
					} else {
						body, _ = sjson.Set(body, "mac", value.String())
					}
				}
				...
				*parent, _ = sjson.SetRaw(*parent, "fixedIpAssignments.-1", body)
				return true
			})
		}
	}
...
func (data *SwitchStackRoutingInterfaceDHCP) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *SwitchStackRoutingInterfaceDHCP) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *SwitchStackRoutingInterfaceDHCP) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data SwitchStackRoutingInterfaceDHCP) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
