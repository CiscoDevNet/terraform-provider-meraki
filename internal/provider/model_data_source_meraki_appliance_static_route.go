...
// It emits a separate model - DataSourceApplianceStaticRoute - used only by the data source, always including every
...
func (data DataSourceApplianceStaticRoute) getPath() string {
