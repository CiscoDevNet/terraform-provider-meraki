...
func TestAccMerakiApplianceThirdPartyVPNPeers(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_appliance_third_party_vpn_peers.test", "peers.0.ip_version", "4"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_appliance_third_party_vpn_peers.test", "peers.0.group_active_active_tunnel", "false"))
