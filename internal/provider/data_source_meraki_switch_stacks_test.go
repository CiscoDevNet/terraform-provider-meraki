...
func TestAccDataSourceMerakiSwitchStacks(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceMerakiSwitchStacksPrerequisitesConfig + testAccDataSourceMerakiSwitchStacksConfig(),
			},
		},
	})
}
...
const testAccDataSourceMerakiSwitchStacksPrerequisitesConfig = `
variable "test_org" {}
...
func testAccDataSourceMerakiSwitchStacksConfig() string {
	config := `data "meraki_switch_stacks" "test" {
			network_id = meraki_network.test.id
		}
	`
	return config
