...
// It emits a separate model - DataSourceApplianceFirewalledService - used only by the data source, always including every
...
type DataSourceApplianceFirewalledService struct {
...
func (data DataSourceApplianceFirewalledService) getPath() string {
...
func (data *DataSourceApplianceFirewalledService) fromBody(ctx context.Context, res meraki.Res) {
