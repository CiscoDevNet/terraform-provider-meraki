...
func (data WirelessEthernetPortProfileDefault) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
...
func (data *WirelessEthernetPortProfileDefault) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *WirelessEthernetPortProfileDefault) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *WirelessEthernetPortProfileDefault) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data WirelessEthernetPortProfileDefault) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
