...
var (
	_ datasource.DataSource              = &ApplianceRadioSettingsDataSource{}
	_ datasource.DataSourceWithConfigure = &ApplianceRadioSettingsDataSource{}
)

func NewApplianceRadioSettingsDataSource() datasource.DataSource {
	return &ApplianceRadioSettingsDataSource{}
}

type ApplianceRadioSettingsDataSource struct {
	client *meraki.Client
}

func (d *ApplianceRadioSettingsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_appliance_radio_settings"
}

func (d *ApplianceRadioSettingsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Appliance Radio Settings` configuration.").String,
...
func (d *ApplianceRadioSettingsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *ApplianceRadioSettingsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DataSourceApplianceRadioSettings
