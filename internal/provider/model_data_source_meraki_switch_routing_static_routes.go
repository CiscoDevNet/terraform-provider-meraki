...
type DataSourceSwitchRoutingStaticRoutes struct {
	Serial types.String                               `tfsdk:"serial"`
	Items  []DataSourceSwitchRoutingStaticRoutesItems `tfsdk:"items"`
}

type DataSourceSwitchRoutingStaticRoutesItems struct {
...
func (data DataSourceSwitchRoutingStaticRoutes) getPath() string {
...
func (data *DataSourceSwitchRoutingStaticRoutes) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceSwitchRoutingStaticRoutesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceSwitchRoutingStaticRoutesItems{}
