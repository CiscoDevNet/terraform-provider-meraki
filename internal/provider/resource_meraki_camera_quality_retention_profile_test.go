...
func TestAccMerakiCameraQualityRetentionProfile(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_camera_quality_retention_profile.test", "video_settings_mv53_x_quality", ""))
	checks = append(checks, resource.TestCheckResourceAttr("meraki_camera_quality_retention_profile.test", "video_settings_mv53_x_resolution", ""))
