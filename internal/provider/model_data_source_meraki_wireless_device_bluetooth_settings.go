...
// It emits a separate model - DataSourceWirelessDeviceBluetoothSettings - used only by the data source, always including every
...
type DataSourceWirelessDeviceBluetoothSettings struct {
...
func (data DataSourceWirelessDeviceBluetoothSettings) getPath() string {
...
func (data *DataSourceWirelessDeviceBluetoothSettings) fromBody(ctx context.Context, res meraki.Res) {
