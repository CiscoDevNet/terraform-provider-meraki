...
type DataSourceSwitchRoutingInterfaces struct {
	Serial types.String                             `tfsdk:"serial"`
	Items  []DataSourceSwitchRoutingInterfacesItems `tfsdk:"items"`
}

type DataSourceSwitchRoutingInterfacesItems struct {
...
func (data DataSourceSwitchRoutingInterfaces) getPath() string {
...
func (data *DataSourceSwitchRoutingInterfaces) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceSwitchRoutingInterfacesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceSwitchRoutingInterfacesItems{}
