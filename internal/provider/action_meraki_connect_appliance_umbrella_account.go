...
var (
	_ action.Action              = &ConnectApplianceUmbrellaAccountAction{}
	_ action.ActionWithConfigure = &ConnectApplianceUmbrellaAccountAction{}
)

func NewConnectApplianceUmbrellaAccountAction() action.Action {
	return &ConnectApplianceUmbrellaAccountAction{}
}

type ConnectApplianceUmbrellaAccountAction struct {
	client *meraki.Client
}

func (a *ConnectApplianceUmbrellaAccountAction) Metadata(ctx context.Context, req action.MetadataRequest, resp *action.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connect_appliance_umbrella_account"
}
...
func (a *ConnectApplianceUmbrellaAccountAction) Schema(ctx context.Context, req action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This action can invoke the `Connect Appliance Umbrella Account` operation.").String,
...
func (a *ConnectApplianceUmbrellaAccountAction) Configure(_ context.Context, req action.ConfigureRequest, resp *action.ConfigureResponse) {
...
func (a *ConnectApplianceUmbrellaAccountAction) Invoke(ctx context.Context, req action.InvokeRequest, resp *action.InvokeResponse) {
	var config ActionConnectApplianceUmbrellaAccount
