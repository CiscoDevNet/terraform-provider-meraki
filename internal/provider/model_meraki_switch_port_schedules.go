...
type SwitchPortSchedules struct {
	...
	Items     []SwitchPortSchedulesItems `tfsdk:"items"`
}

type SwitchPortSchedulesItems struct {
...
func (data SwitchPortSchedules) getPath() string {
...
func (data *SwitchPortSchedules) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]SwitchPortSchedulesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := SwitchPortSchedulesItems{}
