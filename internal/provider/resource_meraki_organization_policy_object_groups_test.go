...
func merakiOrganizationPolicyObjectGroupsImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
const testAccMerakiOrganizationPolicyObjectGroupsPrerequisitesConfig = `
variable "test_org" {}
...
func testAccMerakiOrganizationPolicyObjectGroupsConfig_minimum() string {
...
func testAccMerakiOrganizationPolicyObjectGroupsConfig_all() string {
	config := `resource "meraki_organization_policy_object_groups" "test" {` + "\n"
	config += ` organization_id = data.meraki_organization.test.id` + "\n"
	config += ` items = [{` + "\n"
