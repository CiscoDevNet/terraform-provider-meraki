...
func TestAccMerakiNetwork(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		ImportStateIdFunc:       merakiNetworkImportStateIdFunc("meraki_network.test"),
...
func merakiNetworkImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
