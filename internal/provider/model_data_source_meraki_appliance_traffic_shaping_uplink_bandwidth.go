...
// It emits a separate model - DataSourceApplianceTrafficShapingUplinkBandwidth - used only by the data source, always including every
...
type DataSourceApplianceTrafficShapingUplinkBandwidth struct {
...
func (data DataSourceApplianceTrafficShapingUplinkBandwidth) getPath() string {
...
func (data *DataSourceApplianceTrafficShapingUplinkBandwidth) fromBody(ctx context.Context, res meraki.Res) {
