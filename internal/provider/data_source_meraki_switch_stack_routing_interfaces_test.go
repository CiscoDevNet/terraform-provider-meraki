...
func TestAccDataSourceMerakiSwitchStackRoutingInterfaces(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceMerakiSwitchStackRoutingInterfacesPrerequisitesConfig + testAccDataSourceMerakiSwitchStackRoutingInterfacesConfig(),
			},
		},
	})
}
...
const testAccDataSourceMerakiSwitchStackRoutingInterfacesPrerequisitesConfig = `
variable "test_org" {}
...
func testAccDataSourceMerakiSwitchStackRoutingInterfacesConfig() string {
	config := `data "meraki_switch_stack_routing_interfaces" "test" {
			network_id = meraki_network.test.id
