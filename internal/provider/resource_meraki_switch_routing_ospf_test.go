...
func TestAccMerakiSwitchRoutingOSPF(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		ResourceName:            "meraki_switch_routing_ospf.test",
		ImportState:             true,
		ImportStateVerify:       true,
		ImportStateIdFunc:       merakiSwitchRoutingOSPFImportStateIdFunc("meraki_switch_routing_ospf.test"),
...
func merakiSwitchRoutingOSPFImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
