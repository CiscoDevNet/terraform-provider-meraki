...
type OrganizationAdaptivePolicies struct {
	OrganizationId types.String                        `tfsdk:"organization_id"`
	Items          []OrganizationAdaptivePoliciesItems `tfsdk:"items"`
}

type OrganizationAdaptivePoliciesItems struct {
	...
	Acls                 []OrganizationAdaptivePoliciesAcls `tfsdk:"acls"`
}

type OrganizationAdaptivePoliciesAcls struct {
	Id   types.String `tfsdk:"id"`
...
func (data OrganizationAdaptivePolicies) getPath() string {
...
func (data *OrganizationAdaptivePolicies) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]OrganizationAdaptivePoliciesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := OrganizationAdaptivePoliciesItems{}
		...
		if value := res.Get("acls"); value.Exists() && value.Value() != nil {
			data.Acls = make([]OrganizationAdaptivePoliciesAcls, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := OrganizationAdaptivePoliciesAcls{}
