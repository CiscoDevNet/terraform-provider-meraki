...
type DataSourceApplianceDNSLocalRecords struct {
	OrganizationId types.String                              `tfsdk:"organization_id"`
	Items          []DataSourceApplianceDNSLocalRecordsItems `tfsdk:"items"`
}

type DataSourceApplianceDNSLocalRecordsItems struct {
...
func (data DataSourceApplianceDNSLocalRecords) getPath() string {
...
func (data *DataSourceApplianceDNSLocalRecords) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceApplianceDNSLocalRecordsItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceApplianceDNSLocalRecordsItems{}
