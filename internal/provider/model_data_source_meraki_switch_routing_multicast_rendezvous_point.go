...
// It emits a separate model - DataSourceSwitchRoutingMulticastRendezvousPoint - used only by the data source, always including every
...
type DataSourceSwitchRoutingMulticastRendezvousPoint struct {
...
func (data DataSourceSwitchRoutingMulticastRendezvousPoint) getPath() string {
...
func (data *DataSourceSwitchRoutingMulticastRendezvousPoint) fromBody(ctx context.Context, res meraki.Res) {
