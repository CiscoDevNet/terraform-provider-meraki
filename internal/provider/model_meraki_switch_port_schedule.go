...
func (data *SwitchPortSchedule) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data SwitchPortSchedule) addDeleteValues(ctx context.Context, body string) string {
	return body
}
