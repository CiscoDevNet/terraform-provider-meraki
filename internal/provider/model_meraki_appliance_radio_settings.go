...
func (data ApplianceRadioSettings) getPath() string {
...
func (data ApplianceRadioSettings) toBody(ctx context.Context, state ApplianceRadioSettings) string {
	body := ""
...
func (data ApplianceRadioSettings) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
	if value := res.Get("rfProfileId"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "rfProfileId", "null")
		} else {
			body, _ = sjson.Set(body, "rfProfileId", value.String())
		}
	}
	if value := res.Get("fiveGhzSettings.channel"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "fiveGhzSettings.channel", "null")
		} else {
			body, _ = sjson.Set(body, "fiveGhzSettings.channel", value.Int())
		}
	}
	if value := res.Get("fiveGhzSettings.channelWidth"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "fiveGhzSettings.channelWidth", "null")
		} else {
			body, _ = sjson.Set(body, "fiveGhzSettings.channelWidth", value.Int())
		}
	}
	if value := res.Get("fiveGhzSettings.targetPower"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "fiveGhzSettings.targetPower", "null")
		} else {
			body, _ = sjson.Set(body, "fiveGhzSettings.targetPower", value.Int())
		}
	}
	if value := res.Get("twoFourGhzSettings.channel"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "twoFourGhzSettings.channel", "null")
		} else {
			body, _ = sjson.Set(body, "twoFourGhzSettings.channel", value.Int())
		}
	}
	if value := res.Get("twoFourGhzSettings.targetPower"); value.Exists() {
		if value.Value() == nil {
			body, _ = sjson.SetRaw(body, "twoFourGhzSettings.targetPower", "null")
		} else {
			body, _ = sjson.Set(body, "twoFourGhzSettings.targetPower", value.Int())
		}
	}
	return body
}
...
func (data *ApplianceRadioSettings) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *ApplianceRadioSettings) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *ApplianceRadioSettings) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data ApplianceRadioSettings) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
