...
type NetworkCellularGatewayDHCP struct {
...
func (data NetworkCellularGatewayDHCP) getPath() string {
...
func (data NetworkCellularGatewayDHCP) toBody(ctx context.Context, state NetworkCellularGatewayDHCP) string {
	body := ""
...
func (data *NetworkCellularGatewayDHCP) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *NetworkCellularGatewayDHCP) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *NetworkCellularGatewayDHCP) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
