...
// It emits a separate model - DataSourceAppliancePrefixDelegatedStatic - used only by the data source, always including every
...
type DataSourceAppliancePrefixDelegatedStatic struct {
...
func (data DataSourceAppliancePrefixDelegatedStatic) getPath() string {
...
func (data *DataSourceAppliancePrefixDelegatedStatic) fromBody(ctx context.Context, res meraki.Res) {
