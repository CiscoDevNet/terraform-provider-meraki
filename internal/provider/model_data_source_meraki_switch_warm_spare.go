...
// It emits a separate model - DataSourceSwitchWarmSpare - used only by the data source, always including every
...
type DataSourceSwitchWarmSpare struct {
...
func (data DataSourceSwitchWarmSpare) getPath() string {
...
func (data *DataSourceSwitchWarmSpare) fromBody(ctx context.Context, res meraki.Res) {
