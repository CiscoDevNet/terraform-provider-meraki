...
type DataSourceNetworkVLANProfileAssignmentsByDevice struct {
	NetworkId types.String                                           `tfsdk:"network_id"`
	Items     []DataSourceNetworkVLANProfileAssignmentsByDeviceItems `tfsdk:"items"`
}

type DataSourceNetworkVLANProfileAssignmentsByDeviceItems struct {
...
func (data DataSourceNetworkVLANProfileAssignmentsByDevice) getPath() string {
...
func (data *DataSourceNetworkVLANProfileAssignmentsByDevice) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceNetworkVLANProfileAssignmentsByDeviceItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceNetworkVLANProfileAssignmentsByDeviceItems{}
