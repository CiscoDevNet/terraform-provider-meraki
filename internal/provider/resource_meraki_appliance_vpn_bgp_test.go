...
func TestAccMerakiApplianceVPNBGP(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_appliance_vpn_bgp.test", "neighbors.0.multi_exit_discriminator", "2"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_appliance_vpn_bgp.test", "neighbors.0.weight", "10"))
