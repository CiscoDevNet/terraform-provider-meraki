...
func (data SwitchAlternateManagementInterface) toBodyPreservingNulls(ctx context.Context, res meraki.Res) string {
	body := ""
	...
	if value := res.Get("switches"); value.Exists() {
		if value.Value() == nil {
			...
			value.ForEach(func(k, res gjson.Result) bool {
				...
				*parent, _ = sjson.SetRaw(*parent, "switches.-1", body)
				return true
			})
		}
	}
...
func (data *SwitchAlternateManagementInterface) fromBody(ctx context.Context, res meraki.Res) {
...
func (data *SwitchAlternateManagementInterface) fromBodyPartial(ctx context.Context, res meraki.Res) {
...
func (data *SwitchAlternateManagementInterface) fromBodyUnknowns(ctx context.Context, res meraki.Res) {
}
...
func (data SwitchAlternateManagementInterface) toDestroyBody(ctx context.Context) string {
	body := ""
	return body
}
