...
type DataSourceNetworkGroupPolicies struct {
	NetworkId types.String                          `tfsdk:"network_id"`
	Items     []DataSourceNetworkGroupPoliciesItems `tfsdk:"items"`
}

type DataSourceNetworkGroupPoliciesItems struct {
	...
	BonjourForwardingRules                       []DataSourceNetworkGroupPoliciesBonjourForwardingRules `tfsdk:"bonjour_forwarding_rules"`
	...
	L3FirewallRules                              []DataSourceNetworkGroupPoliciesL3FirewallRules        `tfsdk:"l3_firewall_rules"`
	L7FirewallRules                              []DataSourceNetworkGroupPoliciesL7FirewallRules        `tfsdk:"l7_firewall_rules"`
	TrafficShapingRules                          []DataSourceNetworkGroupPoliciesTrafficShapingRules    `tfsdk:"traffic_shaping_rules"`
...
type DataSourceNetworkGroupPoliciesBonjourForwardingRules struct {
	Description types.String `tfsdk:"description"`
	VlanId      types.String `tfsdk:"vlan_id"`
	Services    types.Set    `tfsdk:"services"`
}

type DataSourceNetworkGroupPoliciesL3FirewallRules struct {
...
type DataSourceNetworkGroupPoliciesL7FirewallRules struct {
	Policy types.String `tfsdk:"policy"`
	Type   types.String `tfsdk:"type"`
	Value  types.String `tfsdk:"value"`
}

type DataSourceNetworkGroupPoliciesTrafficShapingRules struct {
	...
	Definitions                                      []DataSourceNetworkGroupPoliciesTrafficShapingRulesDefinitions `tfsdk:"definitions"`
}

type DataSourceNetworkGroupPoliciesTrafficShapingRulesDefinitions struct {
	Type  types.String `tfsdk:"type"`
	Value types.String `tfsdk:"value"`
}
...
func (data DataSourceNetworkGroupPolicies) getPath() string {
...
func (data *DataSourceNetworkGroupPolicies) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]DataSourceNetworkGroupPoliciesItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := DataSourceNetworkGroupPoliciesItems{}
		...
		if value := res.Get("bonjourForwarding.rules"); value.Exists() && value.Value() != nil {
			data.BonjourForwardingRules = make([]DataSourceNetworkGroupPoliciesBonjourForwardingRules, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := DataSourceNetworkGroupPoliciesBonjourForwardingRules{}
		...
		if value := res.Get("firewallAndTrafficShaping.l3FirewallRules"); value.Exists() && value.Value() != nil {
			data.L3FirewallRules = make([]DataSourceNetworkGroupPoliciesL3FirewallRules, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := DataSourceNetworkGroupPoliciesL3FirewallRules{}
		...
		if value := res.Get("firewallAndTrafficShaping.l7FirewallRules"); value.Exists() && value.Value() != nil {
			data.L7FirewallRules = make([]DataSourceNetworkGroupPoliciesL7FirewallRules, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := DataSourceNetworkGroupPoliciesL7FirewallRules{}
				if value := res.Get("policy"); value.Exists() && value.Value() != nil {
					data.Policy = types.StringValue(value.String())
				} else {
					data.Policy = types.StringNull()
		...
		if value := res.Get("firewallAndTrafficShaping.trafficShapingRules"); value.Exists() && value.Value() != nil {
			data.TrafficShapingRules = make([]DataSourceNetworkGroupPoliciesTrafficShapingRules, 0)
			value.ForEach(func(k, res gjson.Result) bool {
				parent := &data
				data := DataSourceNetworkGroupPoliciesTrafficShapingRules{}
				...
				if value := res.Get("definitions"); value.Exists() && value.Value() != nil {
					data.Definitions = make([]DataSourceNetworkGroupPoliciesTrafficShapingRulesDefinitions, 0)
					value.ForEach(func(k, res gjson.Result) bool {
						parent := &data
						data := DataSourceNetworkGroupPoliciesTrafficShapingRulesDefinitions{}
						if value := res.Get("type"); value.Exists() && value.Value() != nil {
							data.Type = types.StringValue(value.String())
						} else {
							data.Type = types.StringNull()
