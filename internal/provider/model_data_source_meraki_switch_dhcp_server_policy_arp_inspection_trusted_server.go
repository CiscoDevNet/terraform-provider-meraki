...
// It emits a separate model - DataSourceSwitchDHCPServerPolicyARPInspectionTrustedServer - used only by the data source, always including every
...
type DataSourceSwitchDHCPServerPolicyARPInspectionTrustedServer struct {
...
func (data DataSourceSwitchDHCPServerPolicyARPInspectionTrustedServer) getPath() string {
...
func (data *DataSourceSwitchDHCPServerPolicyARPInspectionTrustedServer) fromBody(ctx context.Context, res meraki.Res) {
