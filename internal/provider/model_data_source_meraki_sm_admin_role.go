...
// It emits a separate model - DataSourceSMAdminRole - used only by the data source, always including every
...
type DataSourceSMAdminRole struct {
...
func (data DataSourceSMAdminRole) getPath() string {
...
func (data *DataSourceSMAdminRole) fromBody(ctx context.Context, res meraki.Res) {
