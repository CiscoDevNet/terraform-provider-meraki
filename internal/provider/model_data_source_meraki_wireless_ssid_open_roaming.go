...
// It emits a separate model - DataSourceWirelessSSIDOpenRoaming - used only by the data source, always including every
...
type DataSourceWirelessSSIDOpenRoaming struct {
...
func (data DataSourceWirelessSSIDOpenRoaming) getPath() string {
...
func (data *DataSourceWirelessSSIDOpenRoaming) fromBody(ctx context.Context, res meraki.Res) {
