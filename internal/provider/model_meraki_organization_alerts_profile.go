...
func (data *OrganizationAlertsProfile) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *OrganizationAlertsProfile) fromBodyPartial(ctx context.Context, res gjson.Result) {
