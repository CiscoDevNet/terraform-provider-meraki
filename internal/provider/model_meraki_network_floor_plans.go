...
type NetworkFloorPlans struct {
	NetworkId types.String             `tfsdk:"network_id"`
	Items     []NetworkFloorPlansItems `tfsdk:"items"`
}
...
func (data NetworkFloorPlans) getPath() string {
...
func (data *NetworkFloorPlans) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]NetworkFloorPlansItems, 0)
