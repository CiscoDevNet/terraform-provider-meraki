...
func (d *WirelessSSIDSplashSettingsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the `Wireless SSID Splash Settings` configuration.").String,
		...
		Attributes: map[string]schema.Attribute{
			...
			"self_registration_authorization_type": schema.StringAttribute{
				MarkdownDescription: "How created user accounts should be authorized. Must be included in: [admin, auto, self_email]",
				Computed:            true,
			},
...
func (d *WirelessSSIDSplashSettingsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DataSourceWirelessSSIDSplashSettings
