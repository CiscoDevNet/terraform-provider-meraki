...
func TestAccDataSourceMerakiWirelessNetworkElectronicShelfLabel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_wireless_network_electronic_shelf_label.test", "hostname", "example.com"))
	checks = append(checks, resource.TestCheckResourceAttr("data.meraki_wireless_network_electronic_shelf_label.test", "mode", "high frequency"))
