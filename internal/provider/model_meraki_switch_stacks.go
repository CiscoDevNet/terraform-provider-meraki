...
type SwitchStacks struct {
	...
	Items     []SwitchStacksItems `tfsdk:"items"`
}

type SwitchStacksItems struct {
...
func (data SwitchStacks) getPath() string {
...
func (data *SwitchStacks) fromBody(ctx context.Context, res meraki.Res) {
	data.Items = make([]SwitchStacksItems, 0)
	res.ForEach(func(k, res gjson.Result) bool {
		parent := &data
		data := SwitchStacksItems{}
