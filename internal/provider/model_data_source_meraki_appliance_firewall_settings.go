...
// It emits a separate model - DataSourceApplianceFirewallSettings - used only by the data source, always including every
...
type DataSourceApplianceFirewallSettings struct {
...
func (data DataSourceApplianceFirewallSettings) getPath() string {
...
func (data *DataSourceApplianceFirewallSettings) fromBody(ctx context.Context, res meraki.Res) {
