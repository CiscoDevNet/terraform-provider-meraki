...
// It emits a separate model - DataSourceSwitchAlternateManagementInterface - used only by the data source, always including every
...
type DataSourceSwitchAlternateManagementInterface struct {
	Id        types.String                                           `tfsdk:"id"`
	NetworkId types.String                                           `tfsdk:"network_id"`
	Enabled   types.Bool                                             `tfsdk:"enabled"`
	VlanId    types.Int64                                            `tfsdk:"vlan_id"`
	Protocols types.Set                                              `tfsdk:"protocols"`
	Switches  []DataSourceSwitchAlternateManagementInterfaceSwitches `tfsdk:"switches"`
}

type DataSourceSwitchAlternateManagementInterfaceSwitches struct {
...
func (data DataSourceSwitchAlternateManagementInterface) getPath() string {
...
func (data *DataSourceSwitchAlternateManagementInterface) fromBody(ctx context.Context, res meraki.Res) {
	...
	if value := res.Get("switches"); value.Exists() && value.Value() != nil {
		data.Switches = make([]DataSourceSwitchAlternateManagementInterfaceSwitches, 0)
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DataSourceSwitchAlternateManagementInterfaceSwitches{}
