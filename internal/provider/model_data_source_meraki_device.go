...
// It emits a separate model - DataSourceDevice - used only by the data source, always including every
...
func (data DataSourceDevice) getPath() string {
...
func (data *DataSourceDevice) fromBody(ctx context.Context, res meraki.Res) {
