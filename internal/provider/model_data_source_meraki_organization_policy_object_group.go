...
// It emits a separate model - DataSourceOrganizationPolicyObjectGroup - used only by the data source, always including every
...
type DataSourceOrganizationPolicyObjectGroup struct {
...
func (data DataSourceOrganizationPolicyObjectGroup) getPath() string {
...
func (data *DataSourceOrganizationPolicyObjectGroup) fromBody(ctx context.Context, res meraki.Res) {
