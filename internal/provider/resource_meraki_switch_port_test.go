...
func TestAccMerakiSwitchPort(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("meraki_switch_port.test", "sticky_mac_allow_list.0", "34:56:fe:ce:8e:b0"))
	checks = append(checks, resource.TestCheckResourceAttr("meraki_switch_port.test", "tags.0", "tag1"))
