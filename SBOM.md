...
```bash
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-meraki/main/sbom/latest/sbom.spdx.json
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-meraki/main/sbom/latest/sbom.cyclonedx.json
```
...
VERSION=v1.0.0
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-meraki/main/sbom/${VERSION}/sbom.spdx.json
curl -LO https://raw.githubusercontent.com/CiscoDevNet/terraform-provider-meraki/main/sbom/${VERSION}/sbom.cyclonedx.json
```

### Browse All Versions
View the complete SBOM history in the repository:
https://github.com/CiscoDevNet/terraform-provider-meraki/tree/main/sbom
...
```bash
# SPDX format
jq '.packages[] | select(.name != "terraform-provider-meraki") | {name, version}' sbom/latest/sbom.spdx.json
...
```bash
# Clone repository
git clone https://github.com/CiscoDevNet/terraform-provider-meraki.git
...
If you have questions about SBOM usage or find issues with the generated SBOMs, please [open an issue](https://github.com/CiscoDevNet/terraform-provider-meraki/issues) with the `sbom` label.
