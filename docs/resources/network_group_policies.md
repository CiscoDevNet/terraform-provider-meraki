...
description: |-
  This resource can manage the Network Group Policy configuration in bulk.
...
import {
  to = meraki_network_group_policies.example
  id = "<organization_id>,<network_id>,<force_delete>"
}
```
...
```shell
terraform import meraki_network_group_policies.example "<organization_id>,<network_id>,<force_delete>"
```
