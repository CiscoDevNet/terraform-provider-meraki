...
page_title: "meraki_camera_quality_and_retention Resource - terraform-provider-meraki"
subcategory: "Cameras"
description: |-
  This resource can manage the Camera Quality And Retention configuration.
---

# meraki_camera_quality_and_retention (Resource)
