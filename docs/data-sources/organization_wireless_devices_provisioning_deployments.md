...
page_title: "meraki_organization_wireless_devices_provisioning_deployments Data Source - terraform-provider-meraki"
subcategory: "Wireless"
description: |-
  This data source can read the Organization Wireless Devices Provisioning Deployments configuration.
---

# meraki_organization_wireless_devices_provisioning_deployments (Data Source)
...
```terraform
data "meraki_organization_wireless_devices_provisioning_deployments" "example" {
