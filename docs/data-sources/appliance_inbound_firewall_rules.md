...
page_title: "meraki_appliance_inbound_firewall_rules Data Source - terraform-provider-meraki"
subcategory: "Appliances"
description: |-
  This data source can read the Appliance Inbound Firewall Rules configuration.
---

# meraki_appliance_inbound_firewall_rules (Data Source)
...
```terraform
data "meraki_appliance_inbound_firewall_rules" "example" {
  network_id = "L_123456"
}
```
