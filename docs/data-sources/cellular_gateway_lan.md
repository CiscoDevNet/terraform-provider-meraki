...
page_title: "meraki_cellular_gateway_lan Data Source - terraform-provider-meraki"
subcategory: "Cellular Gateways"
description: |-
  This data source can read the Cellular Gateway LAN configuration.
---

# meraki_cellular_gateway_lan (Data Source)
