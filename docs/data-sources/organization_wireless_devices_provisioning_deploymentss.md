...
page_title: "meraki_organization_wireless_devices_provisioning_deploymentss Data Source - terraform-provider-meraki"
subcategory: "Wireless"
description: |-
  This data source can read the Organization Wireless Devices Provisioning Deployments configuration in bulk.
---

# meraki_organization_wireless_devices_provisioning_deploymentss (Data Source)
...
```terraform
data "meraki_organization_wireless_devices_provisioning_deploymentss" "example" {
...
- `items` (Attributes List) List of zero touch deployments to create (see [below for nested schema](#nestedatt--items--items))
