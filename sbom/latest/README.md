...
This directory contains the Software Bill of Materials (SBOM) for the most recent release of terraform-provider-meraki.
...
curl -LO https://github.com/CiscoDevNet/terraform-provider-meraki/releases/download/${VERSION}/terraform-provider-meraki_${VERSION}_sbom.spdx.json
curl -LO https://github.com/CiscoDevNet/terraform-provider-meraki/releases/download/${VERSION}/terraform-provider-meraki_${VERSION}_sbom.cyclonedx.json

# Copy to sbom/latest/ directory
cp terraform-provider-meraki_${VERSION}_sbom.spdx.json sbom/latest/sbom.spdx.json
cp terraform-provider-meraki_${VERSION}_sbom.cyclonedx.json sbom/latest/sbom.cyclonedx.json
...
- Browse all versions: https://github.com/CiscoDevNet/terraform-provider-meraki/tree/main/sbom
